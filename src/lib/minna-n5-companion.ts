...
export const minnaN5Units: CompanionUnit[] = [
  {
    ...
    explanation: "Japanese noun sentence-এর basic frame হলো topic + information + です। は বাক্যের topic চিহ্নিত করে—অর্থাৎ 'এখন কার/কিসের কথা বলছি'—এবং particle হিসেবে এর উচ্চারণ 'wa'। যেমন わたしは がくせいです (watashi wa gakusei desu) মানে 'আমি শিক্ষার্থী'। নেতিবাচক করতে です-এর জায়গায় বসে ではありません (আনুষ্ঠানিক) অথবা তার নরম রূপ じゃないです (কথ্য)—দুটোই সঠিক, শুধু formality আলাদা: わたしは せんせいではありません এবং わたしは せんせいじゃないです দুটোরই মানে 'আমি শিক্ষক নই'। বাক্যের শেষে か যোগ করলেই সেটা ভদ্র প্রশ্ন হয়ে যায়, word order একদম না বদলেই—がくせいですか মানে 'শিক্ষার্থী?'। は-এর বদলে も বসালে 'ও/also' অর্থ আসে এবং আগের topic-এর সঙ্গে মিল বোঝায়—わたしも がくせいです মানে 'আমিও শিক্ষার্থী'; মনে রাখবেন はも একসঙ্গে বসে না, も একাই は-এর জায়গা নেয়। Context থেকে subject স্পষ্ট থাকলে わたし বারবার বলার প্রয়োজন নেই—শুধু がくせいです বললেই চলে।",
    patterns: ["A は B です。", "A は B ではありません／じゃないです。", "A は B ですか。", "A も B です。"],
    examples: [["わたしは ソフトウェアエンジニアです。", "আমি software engineer।"], ["わたしは バングラデシュじんです。", "আমি বাংলাদেশি।"], ["ラナさんは せんせいではありません。", "Rana শিক্ষক নন।"], ["サミルさんは がくせいじゃないです。", "Samir শিক্ষার্থী নন।"], ["リミさんは がくせいですか。", "Rimi কি শিক্ষার্থী?"], ["はい、リミさんは がくせいです。", "হ্যাঁ, Rimi শিক্ষার্থী।"], ["アリさんも バングラデシュじんです。", "Ali-ও Bangladeshi।"], ["わたしも かいしゃいんです。", "আমিও company employee।"]],
    vocabulary: ["しごと — কাজ/পেশা", "かいしゃいん — company employee", "がくせい — student", "せんせい — teacher (অন্যকে সম্বোধন/বর্ণনায়)", "～じん — nationality suffix", "くに — দেশ", "だれ — কে", "はい — হ্যাঁ", "いいえ — না"],
  ...
  },
  {
    ...
    explanation: "ここ/そこ/あそこ জায়গা নির্দেশ করে—ここ = বক্তার কাছের জায়গা, そこ = শ্রোতার কাছের, あそこ = দুজনের থেকেই দূরের। こちら/そちら/あちら একই অর্থ বহন করে কিন্তু বেশি polite, আর person বা company-কেও ইঙ্গিতে বোঝাতে ব্যবহার হয়—যেমন কাউকে দেখিয়ে こちらは たなかさんです (ইনি তানাকা-সান)। どこ/どちら এদের question form—どちら বেশি ভদ্র এবং direction-ও বোঝাতে পারে। Floor বোঝাতে number-এর পরে かい/がい বসে (いっかい, にかい, さんがい—উচ্চারণ কিছু সংখ্যায় একটু বদলায়)। দাম জানতে いくら ব্যবহার হয় এবং টাকার সংখ্যার পরে সরাসরি 円 বসে, আলাদা particle লাগে না—せんえん (১,০০০ yen)।",
    patterns: ["N は ここ／そこ／あそこです。", "N は どこですか。", "N は こちらです。", "これは いくらですか。"],
    examples: [["うけつけは いっかいです。", "Reception প্রথম floor-এ।"], ["エレベーターは どちらですか。", "Elevator কোন দিকে?"], ["この ケーブルは せんごひゃくえんです。", "এই cable ১,৫০০ yen।"], ["トイレは あそこです。", "Restroom ওইখানে (দূরে)।"], ["かいぎしつは どこですか。", "Meeting room কোথায়?"], ["こちらは たなかさんです。", "ইনি তানাকা-সান।"], ["この ぼうしは いくらですか。", "এই টুপিটার দাম কত?"]],
    vocabulary: ["うけつけ — reception", "かいぎしつ — meeting room", "かい／がい — floor counter", "えん — yen", "いくら — কত দাম", "トイレ — restroom", "エレベーター — elevator", "たかい — দামি", "やすい — সস্তা"],
    mistakes: ["Place question-এ どれ ব্যবহার করা।", "よんかい/ななかい সব ক্ষেত্রে mechanically বলা; floor readings review প্রয়োজন।", "こちら-এর polite nuance না বুঝে শুধু ‘এখানে’ অনুবাদ করা।", "いくら-কে ‘কোথায়’ ভেবে ভুল করা; いくら দাম, どこ জায়গা জিজ্ঞেস করে।"],
    practice: ["নিজের workplace-এর চারটি location Japanese-এ বলুন।", "একটি map দেখে reception ও restroom-এর direction জিজ্ঞাসা করুন।", "তিনটি product-এর কাল্পনিক price question-answer লিখুন।", "こちら ব্যবহার করে কাউকে polite ভাবে introduce করুন।"],
  ...
  },
  {
    ...
    explanation: "ます-form হলো polite non-past—এটি habit (প্রতিদিন করা কাজ) এবং future দুই-ই প্রকাশ করে, কোনটা বোঝাচ্ছে তা context থেকে বোঝা যায়। Past বলতে ました, negative বলতে ません, past-negative বলতে ませんでした বসে—stem একই থাকে, শুধু ending বদলায়: おきます → おきました → おきません → おきませんでした। Exact clock time (৬টা, ৭টা৩০) উল্লেখ করলে তার পরে に বসে: ろくじに। কিন্তু きょう/あした/まいにち-এর মতো relative day-শব্দে সাধারণত に লাগে না—きょう はたらきます (আজ কাজ করি), まいにちに নয়। から শুরু বিন্দু, まで শেষ বিন্দু দেখায়, একসঙ্গেও ব্যবহার হতে পারে: くじから じゅうじまで (৯টা থেকে ১০টা)।",
  ...
  },
  {
    ...
    explanation: "Destination বোঝাতে へ বা に দুটোই ব্যবহার হয়, অর্থ প্রায় একই—とうきょうへ/とうきょうに いきます দুটোই ‘Tokyo যাই’। Transport/vehicle বোঝাতে で বসে: でんしゃで, バスで। Companion (কার সঙ্গে) বোঝাতে と বসে: ともだちと। কিন্তু ‘একা’ বোঝাতে ひとりで ব্যবহার হয়—এখানে と লাগে না, কারণ ‘সঙ্গী নেই’ বলা হচ্ছে। Movement verb-এর tense অবশ্যই সময়ের সঙ্গে মিলতে হবে: গতকাল হলে いきました, ভবিষ্যৎ/নিয়মিত হলে いきます। どこへも-এর পরে negative verb বসিয়ে ‘কোথাও না’ বোঝানো হয়—どこへも いきません; positive-এ も ব্যবহার হয় না।",
