...
export const minnaN5Units: CompanionUnit[] = [
  ...
  {
    number: 7,
    title: "Tools, languages, giving/receiving ও family visit",
    goal: "কী দিয়ে কাজ হয়, কে কাকে কী দিল/পেল, কাজ শেষ হয়েছে কি না এবং বাড়িতে ভদ্রভাবে কথোপকথন—সব এক flow-তে বলা।",
    explanation: "で tool, means বা language বোঝায়: ペンで かきます, にほんごで はなします। あげます-এ subject giver; もらいます-এ subject receiver এবং source-এ に／から বসে। もう Vましたか completed action জানতে ব্যবহৃত হয়; শেষ না হলে いいえ、まだです। Family নিয়ে নিজের পক্ষের 父・母・兄・姉 এবং অন্যের পরিবার বা সম্বোধনের お父さん・お母さん・お兄さん・お姉さん আলাদা রাখুন। Home visit-এ いらっしゃい, どうぞ お上がりください, 失礼します, いただきます ও ごちそうさまでした একটি স্বাভাবিক etiquette sequence তৈরি করে。",
    patterns: ["N（tool／means）で Vます。", "『Word／sentence』は ～語で 何ですか。", "A は B に Nを あげます。", "A は B に／から Nを もらいます。", "もう Vましたか。— いいえ、まだです。", "Context স্পষ্ট হলে কথ্য ভাষায় particle omission"],
    ...
    vocabulary: ["はし — chopsticks", "スプーン — spoon", "プレゼント — gift", "かします／かります — ধার দিই/নিই", "おしえます／ならいます — শেখাই/শিখি", "もう／まだ — ইতিমধ্যে/এখনো", "父／お父さん — নিজের বাবা/অন্যের বাবা", "母／お母さん — নিজের মা/অন্যের মা", "失礼します — অনুমতি নিয়ে প্রবেশ করছি"],
    mistakes: ["あげます ও もらいます-এ giver/receiver উল্টে ফেলা।", "Tool-এর সঙ্গে で-এর বদলে を ব্যবহার করা।", "Person source-এ で বসানো।", "もう-এর completion question-এ present form ব্যবহার করা।", "নিজের পরিবারের জন্য অকারণে お～さん ব্যবহার করা।", "Formal writing-এ প্রয়োজনীয় particle বাদ দেওয়া।"],
    practice: ["তিনটি tool দিয়ে কী করেন লিখুন।", "একটি দেওয়া-পাওয়ার ঘটনা দুই arrow perspective-এ বলুন।", "একটি Japanese word Bangla/English-এ কী—question বানান।", "もう／まだ দিয়ে completed ও unfinished কাজ বলুন।", "নিজের ও অন্যের family terms জোড়া বানান।", "Home-visit dialogue role-play করুন।"],
  ...
  },
  {
    ...
    patterns: ["い-adjective + N／な-adjective + な + N", "N は な-adj／い-adj です。", "な-adj じゃありません／い-adj くないです。", "Sentence A が、Sentence B。", "とても + adjective／あまり + negative", "N は どうですか。", "N₁ は どんな N₂ ですか。", "そうですね。"],
  ...
  },
  {
    ...
    patterns: ["N が 好き／嫌い／上手／下手です。", "N が 分かります／あります。", "どんな N が 好きですか。", "よく／少し + affirmative · あまり／全然 + negative", "Reason から、Result。", "どうして ～か。— ～から。"],
