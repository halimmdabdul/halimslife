...
const unit11GrammarDetails: GrammarDetail[] = [
  {title:"সাধারণ জিনিস ১–১০ পর্যন্ত গোনা",structure:"ひとつ・ふたつ・みっつ … とお／いくつ",explanation:"আলাদা counter জানা না থাকলে ১–১০টি সাধারণ জিনিস Japanese native counter দিয়ে গোনা হয়। সংখ্যা noun-এর পরে নয়, সাধারণত particle-সহ object-এর পরে এবং verb-এর ঠিক আগে বসে। প্রশ্নে いくつ ব্যবহার করুন।",notes:["১: ひとつ, ২: ふたつ, ৩: みっつ, ৪: よっつ, ৫: いつつ।","৬: むっつ, ৭: ななつ, ৮: やっつ, ৯: ここのつ, ১০: とお।","১১ থেকে সাধারণত number + উপযুক্ত counter ব্যবহার হয়।"],visual:{tokens:[{text:"りんごを",role:"যে জিনিস"},{text:"四つ",role:"পরিমাণ",accent:true},{text:"買いました",role:"কাজ"}],romaji:"Ringo o yottsu kaimashita.",bengali:"চারটি আপেল কিনেছি।"},examples:[{japanese:"みかんを いくつ 買いましたか。",romaji:"Mikan o ikutsu kaimashita ka.",bengali:"কতটি mandarin কিনেছেন?"},{japanese:"八つ 買いました。",romaji:"Yattsu kaimashita.",bengali:"আটটি কিনেছি।"}]},
  {title:"জিনিস অনুযায়ী সঠিক counter",structure:"Number + 人／台／枚／回",explanation:"মানুষ, যন্ত্র/যান, পাতলা-সমতল বস্তু এবং ঘটনার পুনরাবৃত্তি একই counter দিয়ে গোনা যায় না। তাই noun-এর ধরন দেখে counter বেছে নিতে হয়।",notes:["人: মানুষ—একজন ひとり, দুজন ふたり; এরপর さんにん ইত্যাদি।","台: গাড়ি/কম্পিউটার; 枚: কাগজ/টিকিট/স্ট্যাম্প; 回: কয়বার।","Question-এ 何人・何台・何枚・何回 ব্যবহার করুন।"],visual:{tokens:[{text:"外国人が",role:"মানুষ"},{text:"二人",role:"দুজন",accent:true},{text:"います",role:"আছেন"}],romaji:"Gaikokujin ga futari imasu.",bengali:"দুজন বিদেশি আছেন।"},examples:[{japanese:"切手を 五枚 買いました。",romaji:"Kitte o gomai kaimashita.",bengali:"পাঁচটি ডাকটিকিট কিনেছি।"},{japanese:"車が 三台 あります。",romaji:"Kuruma ga sandai arimasu.",bengali:"তিনটি গাড়ি আছে।"}]},
  {title:"Quantifier-এর স্বাভাবিক জায়গা",structure:"N を／が + Quantifier + V",explanation:"Counter-সহ পরিমাণ সাধারণত সেই verb-এর ঠিক আগে বসে যেটি কাজ বা অস্তিত্ব প্রকাশ করে। Object particle を বা subject marker が নিজের জায়গায় থাকে।",notes:["りんご四つを নয়; りんごを 四つ বেশি স্বাভাবিক।","মানুষ/জীবের অস্তিত্বে います, জড় বস্তুর অস্তিত্বে あります।","পরিমাণকে topic করতে বিশেষ context ছাড়া は লাগাবেন না।"],visual:{tokens:[{text:"切手を",role:"Object"},{text:"十枚",role:"কতটি",accent:true},{text:"買います",role:"Verb"}],romaji:"Kitte o juumai kaimasu.",bengali:"দশটি ডাকটিকিট কিনব।"},examples:[{japanese:"この 会社に 外国人が 五人 います。",romaji:"Kono kaisha ni gaikokujin ga gonin imasu.",bengali:"এই কোম্পানিতে পাঁচজন বিদেশি আছেন।"},{japanese:"アイスクリームを 二つ ください。",romaji:"Aisukuriimu o futatsu kudasai.",bengali:"দুটি ice cream দিন।"}]},
  {title:"সময়কাল ও ‘কতক্ষণ’",structure:"どのくらい + Vますか／Duration + Vます",explanation:"কোনো কাজ কত সময় ধরে হয় বা দুই জায়গার যাত্রায় কত সময় লাগে জানতে どのくらい ব্যবহার হয়। উত্তরে 時間, 週間, か月, 年 ইত্যাদি duration সরাসরি verb-এর আগে বসে; duration-এর পরে に লাগে না।",notes:["～時間 = ঘণ্টা, ～週間 = সপ্তাহ, ～か月 = মাস, ～年 = বছর।","かかります সময় ও খরচ—দুটির ক্ষেত্রেই ব্যবহার হয়।","ぐらい যোগ করলে ‘প্রায়’ বোঝায়।"],visual:{tokens:[{text:"大阪から 東京まで",role:"Route"},{text:"どのくらい",role:"কতক্ষণ",accent:true},{text:"かかりますか",role:"লাগে?"}],romaji:"Oosaka kara Toukyou made dono kurai kakarimasu ka.",bengali:"ওসাকা থেকে টোকিও কতক্ষণ লাগে?"},examples:[{japanese:"新幹線で 二時間半ぐらい かかります。",romaji:"Shinkansen de nijikan han gurai kakarimasu.",bengali:"Shinkansen-এ প্রায় আড়াই ঘণ্টা লাগে।"},{japanese:"日本語を 三年 勉強しました。",romaji:"Nihongo o sannen benkyou shimashita.",bengali:"তিন বছর জাপানি পড়েছি।"}]},
  {title:"নির্দিষ্ট সময়ে কয়বার",structure:"Time period に Frequency 回 + V",explanation:"একটি নির্দিষ্ট সময়সীমার মধ্যে কোনো কাজ কতবার ঘটে বলতে সময়সীমার পরে に এবং frequency counter 回 ব্যবহার হয়।",notes:["一週間に = প্রতি সপ্তাহে/এক সপ্তাহে।","何回 দিয়ে কয়বার জানতে চান।","একবার いっかい, ছয়বার ろっかい, আটবার はっかい—উচ্চারণে পরিবর্তন হয়।"],visual:{tokens:[{text:"一か月",role:"সময়সীমা"},{text:"に",role:"প্রতি",accent:true},{text:"二回",role:"frequency",accent:true},{text:"映画を 見ます",role:"কাজ"}],romaji:"Ikkagetsu ni nikai eiga o mimasu.",bengali:"মাসে দুইবার সিনেমা দেখি।"},examples:[{japanese:"一週間に 何回 テニスを しますか。",romaji:"Isshuukan ni nankai tenisu o shimasu ka.",bengali:"সপ্তাহে কয়বার tennis খেলেন?"},{japanese:"三回 します。",romaji:"Sankai shimasu.",bengali:"তিনবার খেলি।"}]},
