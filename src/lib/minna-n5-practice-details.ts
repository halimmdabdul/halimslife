...
const unitFifteenPractice: UnitPracticeDetails = {
  heroImage: "/images/projects/n5-vocabulary/unit-15.webp",
  heroAlt: "অনুমতি, নিষেধ, পেশা ও পরিবারের continuing state নিয়ে Unit 15 practice illustration",
  dialogueImage: "/images/projects/n5-vocabulary/unit-15.webp",
  heroEyebrow: "UNIT 15 · PERMISSION · PROHIBITION · STATE",
  heroTitle: "অনুমতি চান, নিয়ম বলুন, আর স্থায়ী অবস্থা বর্ণনা করুন",
  heroDescription: "Vてもいいですか দিয়ে permission, Vてはいけません দিয়ে prohibition এবং Vています দিয়ে residence, occupation, knowledge ও marital state—বইয়ের exercise flow-তে practice করুন।",
  dialogueTitle: "ご家族は？ · Family conversation",
  dialogueAlt: "সিনেমার পরে দুই সহকর্মী পরিবার, বসবাস ও পেশা নিয়ে কথা বলছেন",
  dialogueCaption: [
    { name: "木村", text: "いい 映画でしたね。" },
    { name: "ミラー", text: "ええ。わたしは 家族を 思い出しました。" },
    { name: "木村", text: "ご家族は どちらに いらっしゃいますか。" },
  ],
  modelLabel: "文型モデル",
  modelTitle: "Vてもいいですか · Vてはいけません · Vています",
  challengeTitle: "Public-space rule mission",
  challengeDescription: "Library, museum, office ও park-এর জন্য permission question, prohibition এবং staff-এর occupation/state মিলিয়ে অন্তত আটটি Japanese sentence বলুন।",
  usefulWords: [
    { japanese: "～ても いいですか", romaji: "~te mo ii desu ka", bengali: "～করতে পারি?" },
    { japanese: "ええ、どうぞ", romaji: "ee, douzo", bengali: "হ্যাঁ, করুন/নিন" },
    { japanese: "すみません、ちょっと…", romaji: "sumimasen, chotto", bengali: "দুঃখিত, একটু অসুবিধা…" },
    { japanese: "～ては いけません", romaji: "~te wa ikemasen", bengali: "～করা নিষেধ" },
    { japanese: "知っています", romaji: "shitte imasu", bengali: "জানি/চিনি" },
    { japanese: "知りません", romaji: "shirimasen", bengali: "জানি না/চিনি না" },
    { japanese: "住んでいます", romaji: "sunde imasu", bengali: "বসবাস করি" },
    { japanese: "働いています", romaji: "hataraite imasu", bengali: "কাজ করি" },
  ],
  answerPatterns: [
    { japanese: "Vても いいですか。", romaji: "V-te mo ii desu ka.", bengali: "কাজটি করতে পারি?", positive: true },
    { japanese: "ええ、いいですよ。どうぞ。", romaji: "Ee, ii desu yo. Douzo.", bengali: "হ্যাঁ, করতে পারেন।", positive: true },
    { japanese: "すみません、ちょっと…。", romaji: "Sumimasen, chotto...", bengali: "দুঃখিত, এখন সম্ভব নয়।", positive: false },
    { japanese: "Vては いけません。", romaji: "V-te wa ikemasen.", bengali: "কাজটি করা যাবে না।", positive: false },
    { japanese: "Nに 住んでいます。", romaji: "N ni sunde imasu.", bengali: "N-এ বসবাস করি।", positive: true },
  ],
  memoryPoints: [
    { symbol: "てもいい", meaning: "অনুমতি—করলেও ঠিক আছে" },
    { symbol: "てはいけない", meaning: "নিষেধ—করলে চলবে না" },
    { symbol: "ています", meaning: "চলমান action ছাড়াও habit/state" },
    { symbol: "知りません", meaning: "知っています-এর natural negative" },
    { symbol: "に", meaning: "বসবাস বা resulting location" },
    { symbol: "で", meaning: "কাজ বা teaching-এর action location" },
  ],
  selfIntroduction: {
    japanese: "わたしは 東京に 住んでいます。IT会社で 働いています。ソフトを 作っています。結婚していません。日本橋を 知っていますが、そこへ 行ったことは ありません。",
    romaji: "Watashi wa Toukyou ni sunde imasu. IT-gaisha de hataraite imasu. Sofuto o tsukutte imasu. Kekkon shite imasen. Nipponbashi o shitte imasu ga, soko e itta koto wa arimasen.",
    bengali: "আমি Tokyo-তে থাকি। IT company-তে কাজ করি এবং software বানাই। আমি বিবাহিত নই। Nipponbashi চিনি, তবে সেখানে যাইনি।",
  },
  grammarQuiz: [
    { question: "‘এই catalogue-টি নিতে পারি?’—সঠিক sentence কোনটি?", options: ["この カタログを もらっても いいですか。", "この カタログを もらっては いけません。", "この カタログが もらいますか。", "この カタログに もらっています。"], correctAnswer: "この カタログを もらっても いいですか。", explanation: "Permission চাইতে Vて-form + もいいですか ব্যবহার হয়।" },
    { question: "‘এখানে ধূমপান করা যাবে না’—কোনটি ঠিক?", options: ["ここで たばこを 吸ってはいけません。", "ここで たばこを 吸ってもいいです。", "ここに たばこが 住んでいます。", "ここで たばこを 知りません。"], correctAnswer: "ここで たばこを 吸ってはいけません。", explanation: "নিষেধ বোঝাতে Vてはいけません।" },
    { question: "知っています-এর natural negative কোনটি?", options: ["知りません", "知っていません", "知らないですか", "知りていません"], correctAnswer: "知りません", explanation: "কাউকে বা তথ্য না জানলে সাধারণত 知りません বলা হয়।" },
    { question: "‘Osaka-তে থাকি’—কোন particle লাগবে?", options: ["大阪に 住んでいます。", "大阪で 住んでいます。", "大阪を 住んでいます。", "大阪が 住んでいます。"], correctAnswer: "大阪に 住んでいます。", explanation: "Residence-এর location 住みます-এর সঙ্গে に নেয়।" },
    { question: "‘High school-এ English পড়ান’—কোনটি ঠিক?", options: ["高校で 英語を 教えています。", "高校に 英語が 教えています。", "高校を 英語に 教えています。", "高校で 英語を 教えてもいいですか。"], correctAnswer: "高校で 英語を 教えています。", explanation: "Teaching action যেখানে ঘটে সেই location-এ で ব্যবহৃত হয়।" },
  ],
  dialogue: [
    { speaker: "木村", japanese: "いい 映画でしたね。", romaji: "Ii eiga deshita ne.", bengali: "ভালো সিনেমা ছিল, তাই না?" },
    { speaker: "ミラー", japanese: "ええ。わたしは 家族を 思い出しました。", romaji: "Ee. Watashi wa kazoku o omoidashimashita.", bengali: "হ্যাঁ। আমার পরিবারের কথা মনে পড়ল।" },
    { speaker: "木村", japanese: "そうですか。ミラーさんの ご家族は？", romaji: "Sou desu ka. Miraa-san no gokazoku wa?", bengali: "তাই নাকি। আপনার পরিবারে কে কে আছেন?" },
    { speaker: "ミラー", japanese: "両親と 姉が 一人 います。", romaji: "Ryoushin to ane ga hitori imasu.", bengali: "বাবা-মা এবং একজন বড় বোন আছেন।" },
    { speaker: "木村", japanese: "どちらに いらっしゃいますか。", romaji: "Dochira ni irasshaimasu ka.", bengali: "তাঁরা কোথায় আছেন?" },
    { speaker: "ミラー", japanese: "両親は ニューヨークの 近くに 住んでいます。姉は ロンドンで 働いています。", romaji: "Ryoushin wa Nyuuyooku no chikaku ni sunde imasu. Ane wa Rondon de hataraite imasu.", bengali: "বাবা-মা New York-এর কাছে থাকেন। বোন London-এ কাজ করেন।" },
    { speaker: "ミラー", japanese: "木村さんの ご家族は？", romaji: "Kimura-san no gokazoku wa?", bengali: "কিমুরা-সানের পরিবারে কে কে আছেন?" },
    { speaker: "木村", japanese: "三人です。父は 銀行員です。母は 高校で 英語を 教えています。", romaji: "Sannin desu. Chichi wa ginkouin desu. Haha wa koukou de Eigo o oshiete imasu.", bengali: "তিনজন। বাবা ব্যাংক কর্মচারী; মা high school-এ English পড়ান।" },
  ],
  profiles: [],
  modules: [
    { step: "01", title: "文型・例文 · Permission and state", instruction: "বইয়ের model sentence অনুসরণ করে permission এবং continuing state-এর পূর্ণ উত্তর বলুন।", questions: [
      { prompt: "写真／撮ります／permission", answer: "写真を 撮っても いいですか。", romaji: "Shashin o totte mo ii desu ka.", bengali: "ছবি তুলতে পারি?" },
      { prompt: "サントスさん／電子辞書／持ちます", answer: "サントスさんは 電子辞書を 持っています。", romaji: "Santosu-san wa denshi jisho o motte imasu.", bengali: "সান্তোস-সানের electronic dictionary আছে।" },
      { prompt: "市役所の 電話番号／知ります／question", answer: "市役所の 電話番号を 知っていますか。— いいえ、知りません。", romaji: "Shiyakusho no denwa bangou o shitte imasu ka. — Iie, shirimasen.", bengali: "City hall-এর ফোন নম্বর জানেন?—না, জানি না।" },
      { prompt: "ワンさん／結婚／question", answer: "ワンさんは 結婚していますか。— いいえ、独身です。", romaji: "Wan-san wa kekkon shite imasu ka. — Iie, dokushin desu.", bengali: "ওয়ান-সান বিবাহিত?—না, অবিবাহিত।" },
    ] },
    { step: "02", title: "練習A · Vてもいいですか", instruction: "ます-form cue-কে て-form-এ বদলে অনুমতি চান।", questions: [
      { prompt: "この ホッチキスを 使います", answer: "この ホッチキスを 使っても いいですか。", romaji: "Kono hocchikisu o tsukatte mo ii desu ka.", bengali: "এই stapler ব্যবহার করতে পারি?" },
      { prompt: "ここに 名前を 書きます", answer: "ここに 名前を 書いても いいですか。", romaji: "Koko ni namae o kaite mo ii desu ka.", bengali: "এখানে নাম লিখতে পারি?" },
      { prompt: "お酒を 飲みます", answer: "お酒を 飲んでも いいですか。", romaji: "Osake o nonde mo ii desu ka.", bengali: "মদ পান করতে পারি?" },
      { prompt: "この 傘を 持って 帰ります", answer: "この 傘を 持って 帰っても いいですか。", romaji: "Kono kasa o motte kaette mo ii desu ka.", bengali: "এই ছাতাটি সঙ্গে নিয়ে বাড়ি যেতে পারি?" },
    ] },
    { step: "03", title: "練習B · Permission response", instruction: "Situation অনুযায়ী ええ、どうぞ অথবা নম্র refusal দিয়ে পূর্ণ question-answer বলুন।", questions: [
      { prompt: "この 辞書／借ります → yes", answer: "この 辞書を 借りても いいですか。— ええ、どうぞ。", romaji: "Kono jisho o karite mo ii desu ka. — Ee, douzo.", bengali: "এই dictionary ধার নিতে পারি?—হ্যাঁ, নিন।" },
      { prompt: "写真／撮ります → no", answer: "写真を 撮っても いいですか。— すみません、ちょっと…。", romaji: "Shashin o totte mo ii desu ka. — Sumimasen, chotto...", bengali: "ছবি তুলতে পারি?—দুঃখিত, একটু অসুবিধা…।" },
      { prompt: "ここ／座ります → yes", answer: "ここに 座っても いいですか。— ええ、いいですよ。", romaji: "Koko ni suwatte mo ii desu ka. — Ee, ii desu yo.", bengali: "এখানে বসতে পারি?—হ্যাঁ, পারেন।" },
      { prompt: "この かばん／持って帰ります → no", answer: "この かばんを 持って 帰っても いいですか。— いいえ、いけません。", romaji: "Kono kaban o motte kaette mo ii desu ka. — Iie, ikemasen.", bengali: "এই bag নিয়ে যেতে পারি?—না, পারবেন না।" },
    ] },
    { step: "04", title: "練習B · Vてはいけません", instruction: "Public sign বা rule দেখে prohibition sentence বানান।", questions: [
      { prompt: "ここ／たばこ／吸います", answer: "ここで たばこを 吸ってはいけません。", romaji: "Koko de tabako o sutte wa ikemasen.", bengali: "এখানে ধূমপান করা যাবে না।" },
      { prompt: "美術館／写真／撮ります", answer: "美術館で 写真を 撮ってはいけません。", romaji: "Bijutsukan de shashin o totte wa ikemasen.", bengali: "শিল্প জাদুঘরে ছবি তোলা নিষেধ।" },
      { prompt: "ここ／車／止めます", answer: "ここに 車を 止めてはいけません。", romaji: "Koko ni kuruma o tomete wa ikemasen.", bengali: "এখানে গাড়ি পার্ক করা যাবে না।" },
      { prompt: "この 部屋／入ります", answer: "この 部屋に 入ってはいけません。", romaji: "Kono heya ni haitte wa ikemasen.", bengali: "এই ঘরে প্রবেশ করা যাবে না।" },
    ] },
    { step: "05", title: "練習B · 知っています／持っています", instruction: "চেনা, জানা, possession ও residence-এর cue দেখে natural response দিন।", questions: [
      { prompt: "カリナさん／知っています → yes", answer: "カリナさんを 知っていますか。— はい、知っています。", romaji: "Karina-san o shitte imasu ka. — Hai, shitte imasu.", bengali: "কারিনা-সানকে চেনেন?—হ্যাঁ, চিনি।" },
      { prompt: "車／持っています → no", answer: "車を 持っていますか。— いいえ、持っていません。", romaji: "Kuruma o motte imasu ka. — Iie, motte imasen.", bengali: "গাড়ি আছে?—না, নেই।" },
      { prompt: "東京／住んでいます → yes", answer: "東京に 住んでいますか。— はい、住んでいます。", romaji: "Toukyou ni sunde imasu ka. — Hai, sunde imasu.", bengali: "Tokyo-তে থাকেন?—হ্যাঁ।" },
      { prompt: "木村さんの 住所／知っています → no", answer: "木村さんの 住所を 知っていますか。— いいえ、知りません。", romaji: "Kimura-san no juusho o shitte imasu ka. — Iie, shirimasen.", bengali: "কিমুরা-সানের ঠিকানা জানেন?—না।" },
    ] },
    { step: "06", title: "練習B · Work, products and occupation", instruction: "Company, product, study ও workplace-এর তথ্য Vています দিয়ে বলুন।", questions: [
      { prompt: "IMC／コンピューターソフト／売ります", answer: "IMCは コンピューターソフトを 売っています。", romaji: "IMC wa konpyuutaa sofuto o utte imasu.", bengali: "IMC computer software বিক্রি করে।" },
      { prompt: "あの 店／何／売ります → clothes", answer: "あの 店は 何を 売っていますか。— 服を 売っています。", romaji: "Ano mise wa nani o utte imasu ka. — Fuku o utte imasu.", bengali: "ওই দোকানে কী বিক্রি হয়?—পোশাক।" },
      { prompt: "さくら大学／どの コンピューター／使います", answer: "さくら大学は どの コンピューターを 使っていますか。", romaji: "Sakura Daigaku wa dono konpyuutaa o tsukatte imasu ka.", bengali: "Sakura University কোন computer ব্যবহার করে?" },
      { prompt: "パワー電気／何／作ります → 電子製品", answer: "パワー電気は 何を 作っていますか。— 電子製品を 作っています。", romaji: "Pawaa Denki wa nani o tsukutte imasu ka. — Denshi seihin o tsukutte imasu.", bengali: "Power Electric কী তৈরি করে?—Electronic products।" },
      { prompt: "ワットさん／どこ／教えます", answer: "ワットさんは どこで 教えていますか。— さくら大学で 教えています。", romaji: "Watto-san wa doko de oshiete imasu ka. — Sakura Daigaku de oshiete imasu.", bengali: "ওয়াট-সান কোথায় পড়ান?—Sakura University-তে।" },
    ] },
    { step: "07", title: "練習C・会話 · Permission and family", instruction: "Short role-play ও family dialogue-এর cue ধরে দুই পক্ষের সম্পূর্ণ কথা বলুন।", questions: [
      { prompt: "catalogue নিতে permission", answer: "この カタログを もらっても いいですか。— ええ、どうぞ。", romaji: "Kono katarogu o moratte mo ii desu ka. — Ee, douzo.", bengali: "এই catalogue নিতে পারি?—হ্যাঁ, নিন।" },
      { prompt: "ভালো dentist চেনেন? location বলুন", answer: "いい 歯医者を 知っていますか。— ええ。駅の 近くに あります。", romaji: "Ii haisha o shitte imasu ka. — Ee. Eki no chikaku ni arimasu.", bengali: "ভালো dentist চেনেন?—হ্যাঁ, station-এর কাছে।" },
      { prompt: "ミラーさん／IMC／働きます", answer: "ミラーさんは IMCで 働いています。", romaji: "Miraa-san wa IMC de hataraite imasu.", bengali: "মিলার-সান IMC-তে কাজ করেন।" },
      { prompt: "parents কোথায় থাকেন?", answer: "両親は ニューヨークの 近くに 住んでいます。", romaji: "Ryoushin wa Nyuuyooku no chikaku ni sunde imasu.", bengali: "বাবা-মা New York-এর কাছে থাকেন।" },
    ] },
    { step: "08", title: "問題 · Unit 15 self-test", instruction: "Permission, prohibition, state, occupation ও reading মিলিয়ে পূর্ণ উত্তর দিন।", questions: [
      { prompt: "あした／休みます／permission", answer: "あした 休んでも いいですか。", romaji: "Ashita yasunde mo ii desu ka.", bengali: "আগামীকাল ছুটি নিতে পারি?" },
      { prompt: "美術館／写真／permission", answer: "美術館で 写真を 撮っても いいですか。", romaji: "Bijutsukan de shashin o totte mo ii desu ka.", bengali: "শিল্প জাদুঘরে ছবি তুলতে পারি?" },
      { prompt: "この 部屋／入ります／prohibition", answer: "この 部屋に 入ってはいけません。", romaji: "Kono heya ni haitte wa ikemasen.", bengali: "এই ঘরে প্রবেশ করা নিষেধ।" },
      { prompt: "ミラーさん／大阪／residence", answer: "ミラーさんは 大阪に 住んでいます。", romaji: "Miraa-san wa Oosaka ni sunde imasu.", bengali: "মিলার-সান Osaka-তে থাকেন।" },
      { prompt: "木村さん／ソフト／occupation", answer: "木村さんは コンピューターソフトを 作っています。", romaji: "Kimura-san wa konpyuutaa sofuto o tsukutte imasu.", bengali: "কিমুরা-সান computer software তৈরি করেন।" },
      { prompt: "家族 passage: 姉は どこで 働いていますか", answer: "ロンドンで 働いています。", romaji: "Rondon de hataraite imasu.", bengali: "তিনি London-এ কাজ করেন।" },
    ] },
  ],
};

const unitSixteenPractice: UnitPracticeDetails = {
  heroImage: "/images/projects/n5-vocabulary/unit-16.webp",
  heroAlt: "সকালের routine, train route, ATM এবং মানুষ ও শহরের description নিয়ে Unit 16 practice illustration",
  dialogueImage: "/images/projects/n5-vocabulary/unit-16.webp",
  heroEyebrow: "UNIT 16 · SEQUENCE · CONNECTION · ROUTE",
  heroTitle: "কাজগুলো জুড়ুন, বৈশিষ্ট্য মিলান, আর route বুঝিয়ে বলুন",
  heroDescription: "Vて sequence, Vてから, adjective/noun connection, N₁はN₂が adjective, どうやって এবং どれ／どの—ATM ও travel situation দিয়ে practice করুন।",
  dialogueTitle: "使い方を 教えてください · ATM conversation",
  dialogueAlt: "Bank employee ATM থেকে টাকা তোলার ধাপ বুঝিয়ে দিচ্ছেন",
  dialogueCaption: [
    { name: "ミラー", text: "すみませんが、ちょっと 使い方を 教えてください。" },
    { name: "銀行員", text: "まず ここを 押してください。" },
    { name: "銀行員", text: "それから、この 確認ボタンを 押してください。" },
  ],
  modelLabel: "文型モデル",
  modelTitle: "Vて、Vて · Vてから · Adjくて／で · どうやって",
  challengeTitle: "Morning-to-ATM route mission",
  challengeDescription: "নিজের morning routine, বাড়ি থেকে station-এর route এবং ATM-এ টাকা তোলার ধাপ—তিনটি sequence Japanese-এ বলুন।",
  usefulWords: [
    { japanese: "まず", romaji: "mazu", bengali: "প্রথমে" },
    { japanese: "次に", romaji: "tsugi ni", bengali: "এরপর" },
    { japanese: "それから", romaji: "sorekara", bengali: "তারপর" },
    { japanese: "～てから", romaji: "~te kara", bengali: "～করার পরে" },
    { japanese: "どうやって", romaji: "douyatte", bengali: "কীভাবে" },
    { japanese: "どれ", romaji: "dore", bengali: "কোনটি—তিন বা বেশি থেকে" },
    { japanese: "どの～", romaji: "dono", bengali: "কোন～" },
    { japanese: "確認ボタン", romaji: "kakunin botan", bengali: "confirm button" },
  ],
  answerPatterns: [
    { japanese: "Vて、Vて、Vます。", romaji: "V-te, V-te, V-masu.", bengali: "একটির পর একটি কাজ করি।", positive: true },
    { japanese: "Vてから、Vます。", romaji: "V-te kara, V-masu.", bengali: "প্রথম কাজ শেষ করে তারপর দ্বিতীয়টি করি।", positive: true },
    { japanese: "い-adjくて／な-adjで、～。", romaji: "i-adj-kute / na-adj-de", bengali: "দুটি সামঞ্জস্যপূর্ণ গুণ জুড়ি।", positive: true },
    { japanese: "N₁は N₂が Adjです。", romaji: "N1 wa N2 ga adj desu.", bengali: "N₁-এর N₂ বৈশিষ্ট্যটি এমন।", positive: true },
    { japanese: "Nまで どうやって 行きますか。", romaji: "N made douyatte ikimasu ka.", bengali: "N পর্যন্ত কীভাবে যান?", positive: true },
  ],
  memoryPoints: [
    { symbol: "Vて、Vて", meaning: "ঘটনার ক্রম; tense শেষ verb-এ" },
    { symbol: "Vてから", meaning: "প্রথম কাজ সম্পূর্ণ হওয়ার পর" },
    { symbol: "～くて", meaning: "い-adjective connector; いい→よくて" },
    { symbol: "～で", meaning: "な-adjective ও noun connector" },
    { symbol: "N₂が", meaning: "topic-এর বিশেষ বৈশিষ্ট্য" },
    { symbol: "を 出る／降りる", meaning: "যে স্থান বা যান ছেড়ে বের হই" },
  ],
  selfIntroduction: {
    japanese: "毎朝 6時に 起きて、ジョギングをして、シャワーを 浴びます。朝ごはんを 食べてから、電車で 会社へ 行きます。会社は 駅から 近くて、便利です。",
    romaji: "Maiasa rokuji ni okite, jogingu o shite, shawaa o abimasu. Asagohan o tabete kara, densha de kaisha e ikimasu. Kaisha wa eki kara chikakute, benri desu.",
    bengali: "প্রতিদিন ছয়টায় উঠে jogging করে shower নিই। নাশতা খাওয়ার পরে train-এ অফিসে যাই। অফিস station-এর কাছে এবং সুবিধাজনক।",
  },
  grammarQuiz: [
    { question: "Action sequence-এর tense কোন verb নির্ধারণ করে?", options: ["শেষ verb", "প্রথম verb", "সব て-form", "particle が"], correctAnswer: "শেষ verb", explanation: "Vて sequence-এ মাঝের verb tense দেখায় না; শেষ verb পুরো sentence-এর tense নির্ধারণ করে।" },
    { question: "‘খাওয়ার পরে পড়ি’—সঠিক sentence কোনটি?", options: ["食べてから、勉強します。", "食べますから、勉強して。", "食べくて、勉強します。", "食べで、勉強します。"], correctAnswer: "食べてから、勉強します。", explanation: "একটি কাজ শেষ হওয়ার পরের কাজ বোঝাতে Vてから।" },
    { question: "若い-এর connector form কোনটি?", options: ["若くて", "若いで", "若って", "若で"], correctAnswer: "若くて", explanation: "い-adjective-এর い বাদ দিয়ে くて বসে।" },
    { question: "‘Maria-র চুল লম্বা’—কোনটি ঠিক?", options: ["マリアさんは 髪が 長いです。", "マリアさんが 髪は 長いです。", "マリアさんは 髪を 長いです。", "マリアさんに 髪で 長いです。"], correctAnswer: "マリアさんは 髪が 長いです。", explanation: "Topic-এর বিশেষ বৈশিষ্ট্যে N₁はN₂が adjective।" },
    { question: "Noun-এর আগে ‘কোন’ বলতে কী ব্যবহার হয়?", options: ["どの", "どれ", "どちら", "どうやって"], correctAnswer: "どの", explanation: "どの সরাসরি noun-এর আগে বসে; どれ নিজে pronoun।" },
  ],
  dialogue: [
    { speaker: "ミラー", japanese: "すみませんが、ちょっと 使い方を 教えてください。", romaji: "Sumimasen ga, chotto tsukaikata o oshiete kudasai.", bengali: "মাফ করবেন, ব্যবহার করার নিয়মটি একটু দেখিয়ে দিন।" },
    { speaker: "銀行員", japanese: "お引き出しですか。", romaji: "Ohikidashi desu ka.", bengali: "টাকা তুলবেন?" },
    { speaker: "ミラー", japanese: "そうです。", romaji: "Sou desu.", bengali: "জি।" },
    { speaker: "銀行員", japanese: "じゃ、まず ここを 押してください。", romaji: "Ja, mazu koko o oshite kudasai.", bengali: "তাহলে প্রথমে এখানে চাপুন।" },
    { speaker: "銀行員", japanese: "次に キャッシュカードを ここに 入れて、暗証番号を 押してください。", romaji: "Tsugi ni kyasshu kaado o koko ni irete, anshou bangou o oshite kudasai.", bengali: "এরপর cash card ঢুকিয়ে PIN চাপুন।" },
    { speaker: "ミラー", japanese: "はい、押しました。", romaji: "Hai, oshimashita.", bengali: "জি, চেপেছি।" },
    { speaker: "銀行員", japanese: "じゃ、金額を 押してください。", romaji: "Ja, kingaku o oshite kudasai.", bengali: "তাহলে টাকার পরিমাণ চাপুন।" },
    { speaker: "ミラー", japanese: "5万円ですから、5…。", romaji: "Goman-en desu kara, go...", bengali: "৫০ হাজার ইয়েন, তাই ৫…।" },
    { speaker: "銀行員", japanese: "この『5』『万円』を 押します。それから、この『確認』ボタンを 押してください。", romaji: "Kono go, man-en o oshimasu. Sorekara, kono kakunin botan o oshite kudasai.", bengali: "এই ‘৫’ ও ‘দশ-হাজার ইয়েন’ চাপুন। তারপর confirm button চাপুন।" },
    { speaker: "ミラー", japanese: "はい。どうも ありがとうございました。", romaji: "Hai. Doumo arigatou gozaimashita.", bengali: "জি। অনেক ধন্যবাদ।" },
  ],
  profiles: [],
  modules: [
    { step: "01", title: "文型・例文 · Sequence and description", instruction: "বইয়ের model অনুযায়ী action sequence, てから ও description pattern-এর সম্পূর্ণ sentence বলুন।", questions: [
      { prompt: "毎朝／ジョギング→シャワー→会社", answer: "毎朝 ジョギングをして、シャワーを 浴びて、会社へ 行きます。", romaji: "Maiasa jogingu o shite, shawaa o abite, kaisha e ikimasu.", bengali: "প্রতিদিন jogging করে shower নিয়ে অফিসে যাই।" },
      { prompt: "コンサート終了→restaurant／past", answer: "コンサートが 終わってから、レストランで 食事しました。", romaji: "Konsaato ga owatte kara, resutoran de shokuji shimashita.", bengali: "Concert শেষ হওয়ার পরে restaurant-এ খেয়েছি।" },
      { prompt: "大阪／食べ物／おいしい", answer: "大阪は 食べ物が おいしいです。", romaji: "Oosaka wa tabemono ga oishii desu.", bengali: "Osaka-র খাবার সুস্বাদু।" },
      { prompt: "この 部屋／広い + 明るい", answer: "この 部屋は 広くて、明るいです。", romaji: "Kono heya wa hirokute, akarui desu.", bengali: "এই ঘর প্রশস্ত ও উজ্জ্বল।" },
    ] },
    { step: "02", title: "練習A · Vて sequence", instruction: "তিনটি action-কে সময়ের ক্রমে て-form দিয়ে জুড়ে শেষে সঠিক tense রাখুন।", questions: [
      { prompt: "昨日／梅田へ行く→友達に会う→映画を見る", answer: "昨日 梅田へ 行って、友達に 会って、映画を 見ました。", romaji: "Kinou Umeda e itte, tomodachi ni atte, eiga o mimashita.", bengali: "গতকাল Umeda গিয়ে বন্ধুর সঙ্গে দেখা করে সিনেমা দেখেছি।" },
      { prompt: "朝 6時／起きる→散歩する→朝ごはん", answer: "朝 6時に 起きて、散歩して、それから 朝ごはんを 食べました。", romaji: "Asa rokuji ni okite, sanpo shite, sorekara asagohan o tabemashita.", bengali: "ছয়টায় উঠে হাঁটাহাঁটি করে নাশতা করেছি।" },
      { prompt: "図書館→本を借りる→友達に会う", answer: "図書館へ 行って、本を 借りて、それから 友達に 会いました。", romaji: "Toshokan e itte, hon o karite, sorekara tomodachi ni aimashita.", bengali: "Library গিয়ে বই ধার নিয়ে বন্ধুর সঙ্গে দেখা করেছি।" },
      { prompt: "神戸→映画→お茶／past", answer: "神戸へ 行って、映画を 見て、お茶を 飲みました。", romaji: "Koube e itte, eiga o mite, ocha o nomimashita.", bengali: "Kobe গিয়ে সিনেমা দেখে চা পান করেছি।" },
    ] },
    { step: "03", title: "練習B · Picture sequence", instruction: "ছবির ঘটনাগুলো দেখে て-form chain অথবা てから sentence তৈরি করুন।", questions: [
      { prompt: "wake up→wash face→eat breakfast", answer: "起きて、顔を 洗って、朝ごはんを 食べます。", romaji: "Okite, kao o aratte, asagohan o tabemasu.", bengali: "উঠে মুখ ধুয়ে নাশতা করি।" },
      { prompt: "newspaper→coffee→office", answer: "新聞を 読んで、コーヒーを 飲んで、会社へ 行きます。", romaji: "Shinbun o yonde, koohii o nonde, kaisha e ikimasu.", bengali: "সংবাদপত্র পড়ে coffee খেয়ে অফিসে যাই।" },
      { prompt: "bath→book→sleep", answer: "お風呂に 入って、本を 読んで、寝ます。", romaji: "Ofuro ni haitte, hon o yonde, nemasu.", bengali: "গোসল করে বই পড়ে ঘুমাই।" },
      { prompt: "phone friend→go friend’s house", answer: "友達に 電話してから、友達の うちへ 行きます。", romaji: "Tomodachi ni denwa shite kara, tomodachi no uchi e ikimasu.", bengali: "বন্ধুকে ফোন করার পরে তার বাড়ি যাই।" },
    ] },
    { step: "04", title: "練習A/B · Adjective and noun connection", instruction: "একই subject-এর compatible description-গুলো くて বা で দিয়ে জুড়ুন।", questions: [
      { prompt: "髪／長い + きれい", answer: "あの 人は 髪が 長くて、きれいです。", romaji: "Ano hito wa kami ga nagakute, kirei desu.", bengali: "ওই ব্যক্তির চুল লম্বা এবং তিনি সুন্দর।" },
      { prompt: "奈良／静か + きれい", answer: "奈良は 静かで、きれいな 町です。", romaji: "Nara wa shizuka de, kirei na machi desu.", bengali: "Nara শান্ত ও সুন্দর শহর।" },
      { prompt: "ミラー／28歳 + 独身", answer: "ミラーさんは 28歳で、独身です。", romaji: "Miraa-san wa nijuuhassai de, dokushin desu.", bengali: "মিলার ২৮ বছর বয়সী এবং অবিবাহিত।" },
      { prompt: "富士大学／緑が多い + きれい", answer: "富士大学は 緑が 多くて、きれいです。", romaji: "Fuji Daigaku wa midori ga ookute, kirei desu.", bengali: "Fuji University-তে সবুজ বেশি এবং সুন্দর।" },
    ] },
    { step: "05", title: "練習B · N₁は N₂が Adj", instruction: "Topic-এর উল্লেখযোগ্য অংশ বা বৈশিষ্ট্যকে が দিয়ে mark করে sentence বলুন।", questions: [
      { prompt: "この カメラ／大きい + 重い", answer: "この カメラは 大きくて、重いです。", romaji: "Kono kamera wa ookikute, omoi desu.", bengali: "এই camera বড় ও ভারী।" },
      { prompt: "ワットさん／親切 + すてき", answer: "ワットさんは 親切で、すてきです。", romaji: "Watto-san wa shinsetsu de, suteki desu.", bengali: "ওয়াট-সান সদয় ও চমৎকার।" },
      { prompt: "象／鼻／長い", answer: "象は 鼻が 長いです。", romaji: "Zou wa hana ga nagai desu.", bengali: "হাতির শুঁড় লম্বা।" },
      { prompt: "北海道／食べ物／おいしい", answer: "北海道は 食べ物が おいしいです。", romaji: "Hokkaidou wa tabemono ga oishii desu.", bengali: "Hokkaido-র খাবার সুস্বাদু।" },
    ] },
    { step: "06", title: "練習C · どうやって行きますか", instruction: "Starting point, transport change ও destination মিলিয়ে route-এর question-answer বলুন।", questions: [
      { prompt: "家→京都駅→地下鉄→大学前", answer: "大学まで どうやって 行きますか。— 京都駅から 地下鉄に 乗って、大学前で 降ります。", romaji: "Daigaku made douyatte ikimasu ka. — Kyouto-eki kara chikatetsu ni notte, daigaku-mae de orimasu.", bengali: "University-তে কীভাবে যান?—Kyoto Station থেকে subway-এ উঠে University stop-এ নামি।" },
      { prompt: "大阪→東京／新幹線", answer: "大阪から 東京まで どうやって 行きますか。— 新幹線で 行きます。", romaji: "Oosaka kara Toukyou made douyatte ikimasu ka. — Shinkansen de ikimasu.", bengali: "Osaka থেকে Tokyo কীভাবে যান?—Shinkansen-এ।" },
      { prompt: "ATM／withdraw cash", answer: "ATMで どうやって お金を 下ろしますか。— カードを 入れて、暗証番号を 押します。", romaji: "ATM de douyatte okane o oroshimasu ka. — Kaado o irete, anshou bangou o oshimasu.", bengali: "ATM থেকে কীভাবে টাকা তোলেন?—Card ঢুকিয়ে PIN চাপি।" },
    ] },
    { step: "07", title: "練習C · どれ／どのN", instruction: "তিন বা বেশি item/person থেকে description শুনে সঠিক question ও answer তৈরি করুন।", questions: [
      { prompt: "ミラーさんの 傘／blue one", answer: "ミラーさんの 傘は どれですか。— あの 青い 傘です。", romaji: "Miraa-san no kasa wa dore desu ka. — Ano aoi kasa desu.", bengali: "কোনটি মিলারের ছাতা?—ওই নীলটি।" },
      { prompt: "サントスさん／tall, black hair", answer: "サントスさんは どの 人ですか。— 背が 高くて、髪が 黒い 人です。", romaji: "Santosu-san wa dono hito desu ka. — Se ga takakute, kami ga kuroi hito desu.", bengali: "কোন ব্যক্তি Santos?—লম্বা ও কালো চুলের ব্যক্তি।" },
      { prompt: "カリナさんの かばん／red", answer: "カリナさんの かばんは どれですか。— あの 赤い かばんです。", romaji: "Karina-san no kaban wa dore desu ka. — Ano akai kaban desu.", bengali: "কোনটি কারিনার bag?—ওই লাল bag।" },
      { prompt: "ワットさん／45歳, teacher", answer: "ワットさんは どの 人ですか。— 45歳で、教師の 人です。", romaji: "Watto-san wa dono hito desu ka. — Yonjuugosai de, kyoushi no hito desu.", bengali: "কোন ব্যক্তি ওয়াট-সান?—৪৫ বছর বয়সী শিক্ষক।" },
    ] },
    { step: "08", title: "問題 · Unit 16 self-test", instruction: "Sequence, adjective connection, route, selection ও reading comprehension মিলিয়ে উত্তর দিন।", questions: [
      { prompt: "シャワー／浴びる→朝ごはん／食べる→会社", answer: "シャワーを 浴びて、朝ごはんを 食べて、会社へ 行きます。", romaji: "Shawaa o abite, asagohan o tabete, kaisha e ikimasu.", bengali: "Shower নিয়ে নাশতা করে অফিসে যাই।" },
      { prompt: "東京／人が多い + にぎやか", answer: "東京は 人が 多くて、にぎやかです。", romaji: "Toukyou wa hito ga ookute, nigiyaka desu.", bengali: "Tokyo-তে মানুষ বেশি এবং জমজমাট।" },
      { prompt: "ワンさん／髪／short", answer: "ワンさんは 髪が 短いです。", romaji: "Wan-san wa kami ga mijikai desu.", bengali: "ওয়ান-সানের চুল ছোট।" },
      { prompt: "メール送信ের আগে address check", answer: "メールアドレスを 確認してから、メールを 送ります。", romaji: "Meeru adoresu o kakunin shite kara, meeru o okurimasu.", bengali: "Email address যাচাই করার পরে email পাঠাই।" },
      { prompt: "Reading: 奈良と神戸のうち、海がある町は?", answer: "神戸です。神戸は 海が 近くて、おしゃれな 町です。", romaji: "Koube desu. Koube wa umi ga chikakute, oshare na machi desu.", bengali: "Kobe। সমুদ্র কাছে এবং শহরটি stylish।" },
      { prompt: "Reading: 筆者は どの町が好きですか", answer: "神戸が 好きです。", romaji: "Koube ga suki desu.", bengali: "লেখকের Kobe পছন্দ।" },
    ] },
  ],
};

const unitSeventeenPractice: UnitPracticeDetails = {
  heroImage: "/images/projects/n5-vocabulary/unit-17.webp",
  heroAlt: "অসুস্থতা, চিকিৎসকের পরামর্শ, নিষেধ, দায়িত্ব ও deadline নিয়ে Unit 17 practice illustration",
  dialogueImage: "/images/projects/n5-vocabulary/unit-17.webp",
  heroEyebrow: "UNIT 17 · ない-FORM · DUTY · HEALTH",
  heroTitle: "কী করবেন না, কী করতেই হবে, আর কী না করলেও চলে?",
  heroDescription: "ない-form থেকে request, obligation ও optional action তৈরি করুন; doctor–patient conversation এবং deadline practice-এর মাধ্যমে patternগুলো আয়ত্ত করুন।",
  dialogueTitle: "どうしましたか · At the clinic",
  dialogueAlt: "চিকিৎসক রোগীর গলা ব্যথা ও জ্বর পরীক্ষা করে পরামর্শ দিচ্ছেন",
  dialogueCaption: [
    { name: "医者", text: "どうしましたか。" },
    { name: "松本", text: "きのうから のどが 痛くて、熱も 少し あります。" },
    { name: "医者", text: "2、3日 ゆっくり 休んでください。" },
  ],
  modelLabel: "文型モデル",
  modelTitle: "Vないでください · Vなければなりません · Vなくてもいいです",
  challengeTitle: "Clinic and deadline mission",
  challengeDescription: "একজন রোগীকে তিনটি নির্দেশ দিন, নিজের তিনটি দায়িত্ব বলুন এবং দুইটি কাজ না করলেও চলে—Japanese-এ প্রকাশ করুন।",
  usefulWords: [
    { japanese: "どうしましたか", romaji: "dou shimashita ka", bengali: "কী হয়েছে?" },
    { japanese: "～が 痛いです", romaji: "~ ga itai desu", bengali: "～ব্যথা করছে" },
    { japanese: "熱が あります", romaji: "netsu ga arimasu", bengali: "জ্বর আছে" },
    { japanese: "心配しないでください", romaji: "shinpai shinaide kudasai", bengali: "চিন্তা করবেন না" },
    { japanese: "～なければなりません", romaji: "~nakereba narimasen", bengali: "～করতেই হবে" },
    { japanese: "～なくてもいいです", romaji: "~nakute mo ii desu", bengali: "～না করলেও চলে" },
    { japanese: "～までに", romaji: "~ made ni", bengali: "～এর মধ্যে/deadline-এর আগে" },
    { japanese: "お大事に", romaji: "odaiji ni", bengali: "নিজের যত্ন নিন" },
  ],
  answerPatterns: [
    { japanese: "Vないで ください。", romaji: "V-naide kudasai.", bengali: "কাজটি করবেন না।", positive: false },
    { japanese: "Vなければ なりません。", romaji: "V-nakereba narimasen.", bengali: "কাজটি করতেই হবে।", positive: true },
    { japanese: "Vなくても いいです。", romaji: "V-nakute mo ii desu.", bengali: "কাজটি না করলেও চলে।", positive: true },
    { japanese: "Timeまでに V。", romaji: "Time made ni V.", bengali: "নির্দিষ্ট সময়ের মধ্যে কাজটি করি।", positive: true },
  ],
  memoryPoints: [
    { symbol: "か・がさない", meaning: "Group I: i-row থেকে a-row + ない" },
    { symbol: "い→わない", meaning: "買います→買わない" },
    { symbol: "Group II", meaning: "食べます→食べない" },
    { symbol: "Group III", meaning: "します→しない; 来ます→来ない" },
    { symbol: "なければ", meaning: "না করলে—obligation-এর প্রথম অংশ" },
    { symbol: "なくても", meaning: "না করলেও—optional action" },
  ],
  selfIntroduction: {
    japanese: "毎朝 7時までに 起きなければなりません。会社へ 行く 前に 薬を 飲みます。熱が ある日は 無理をしないで、ゆっくり 休みます。日曜日は 早く 起きなくてもいいです。",
    romaji: "Maiasa shichiji made ni okinakereba narimasen. Kaisha e iku mae ni kusuri o nomimasu. Netsu ga aru hi wa muri o shinaide, yukkuri yasumimasu. Nichiyoubi wa hayaku okinakute mo ii desu.",
    bengali: "প্রতিদিন সাতটার মধ্যে উঠতেই হয়। অফিসে যাওয়ার আগে ওষুধ খাই। জ্বর থাকলে জোর না করে বিশ্রাম নিই। রবিবার তাড়াতাড়ি না উঠলেও চলে।",
  },
  grammarQuiz: [
    { question: "書きます-এর ない-form কোনটি?", options: ["書かない", "書きない", "書けない", "書いてない"], correctAnswer: "書かない", explanation: "Group I-তে き sound か-তে বদলে ない বসে।" },
    { question: "‘এখানে ছবি তুলবেন না’—কোনটি ঠিক?", options: ["ここで 写真を 撮らないでください。", "ここで 写真を 撮らなくてもいいです。", "ここで 写真を 撮らなければなりません。", "ここで 写真を 撮りないです。"], correctAnswer: "ここで 写真を 撮らないでください。", explanation: "না করার request হলো Vないでください।" },
    { question: "‘ওষুধ খেতেই হবে’—কোনটি ঠিক?", options: ["薬を 飲まなければなりません。", "薬を 飲まないでください。", "薬を 飲まなくてもいいです。", "薬を 飲みませんでした。"], correctAnswer: "薬を 飲まなければなりません。", explanation: "Obligation-এর জন্য Vなければなりません।" },
    { question: "‘কাল না এলেও চলবে’—কোনটি ঠিক?", options: ["あした 来なくてもいいです。", "あした 来ないでください。", "あした 来なければなりません。", "あした 来てはいけません。"], correctAnswer: "あした 来なくてもいいです。", explanation: "কাজটি প্রয়োজনীয় নয় বোঝাতে Vなくてもいいです।" },
    { question: "‘শুক্রবারের মধ্যে’ কোনটি?", options: ["金曜日までに", "金曜日まで", "金曜日から", "金曜日ごろ"], correctAnswer: "金曜日までに", explanation: "Deadline-এর আগে completion বোঝাতে までに।" },
  ],
  dialogue: [
    { speaker: "医者", japanese: "どうしましたか。", romaji: "Dou shimashita ka.", bengali: "কী হয়েছে?" },
    { speaker: "松本", japanese: "きのうから のどが 痛くて、熱も 少し あります。", romaji: "Kinou kara nodo ga itakute, netsu mo sukoshi arimasu.", bengali: "গতকাল থেকে গলা ব্যথা, সামান্য জ্বরও আছে।" },
    { speaker: "医者", japanese: "そうですか。ちょっと 口を 開けてください。", romaji: "Sou desu ka. Chotto kuchi o akete kudasai.", bengali: "তাই নাকি। মুখটি একটু খুলুন।" },
    { speaker: "医者", japanese: "かぜですね。2、3日 ゆっくり 休んでください。", romaji: "Kaze desu ne. Ni-san nichi yukkuri yasunde kudasai.", bengali: "সর্দি হয়েছে। দুই-তিন দিন ভালোভাবে বিশ্রাম নিন।" },
    { speaker: "松本", japanese: "あのう、あしたから 東京へ 出張しなければなりません。", romaji: "Anou, ashita kara Toukyou e shucchou shinakereba narimasen.", bengali: "কিন্তু কাল থেকে Tokyo-তে business trip-এ যেতেই হবে।" },
    { speaker: "医者", japanese: "じゃ、きょうは 薬を 飲んで、早く 寝てください。", romaji: "Ja, kyou wa kusuri o nonde, hayaku nete kudasai.", bengali: "তাহলে আজ ওষুধ খেয়ে তাড়াতাড়ি ঘুমান।" },
    { speaker: "松本", japanese: "はい。", romaji: "Hai.", bengali: "জি।" },
    { speaker: "医者", japanese: "それから 今晩は お風呂に 入らないでくださいね。", romaji: "Sorekara konban wa ofuro ni hairanaide kudasai ne.", bengali: "আর আজ রাতে গোসল করবেন না।" },
    { speaker: "松本", japanese: "はい、わかりました。", romaji: "Hai, wakarimashita.", bengali: "জি, বুঝেছি।" },
    { speaker: "医者", japanese: "じゃ、お大事に。", romaji: "Ja, odaiji ni.", bengali: "তাহলে নিজের যত্ন নিন।" },
  ],
  profiles: [],
  modules: [
    { step: "01", title: "文型・例文 · ない-form patterns", instruction: "Situation অনুযায়ী prohibition, obligation অথবা optional form বেছে পূর্ণ sentence বলুন।", questions: [
      { prompt: "ここ／車／止めます → request not to", answer: "ここに 車を 止めないでください。", romaji: "Koko ni kuruma o tomenaide kudasai.", bengali: "এখানে গাড়ি রাখবেন না।" },
      { prompt: "passport／見せます → must", answer: "パスポートを 見せなければなりません。", romaji: "Pasupooto o misenakereba narimasen.", bengali: "Passport দেখাতেই হবে।" },
      { prompt: "日曜日／早く起きます → not necessary", answer: "日曜日は 早く 起きなくてもいいです。", romaji: "Nichiyoubi wa hayaku okinakute mo ii desu.", bengali: "রবিবার তাড়াতাড়ি না উঠলেও চলে।" },
      { prompt: "今日／お風呂／negative request", answer: "今日は お風呂に 入らないでください。", romaji: "Kyou wa ofuro ni hairanaide kudasai.", bengali: "আজ গোসল করবেন না।" },
    ] },
    { step: "02", title: "練習A · ない-form builder", instruction: "ます-form দেখে তিনটি related form—ない, なければなりません, なくてもいい—active recall করুন।", questions: [
      { prompt: "書きます", answer: "書かない／書かなければなりません／書かなくてもいいです", romaji: "kakanai / kakanakereba narimasen / kakanakute mo ii desu", bengali: "লিখি না / লিখতেই হবে / না লিখলেও চলে" },
      { prompt: "急ぎます", answer: "急がない／急がなければなりません／急がなくてもいいです", romaji: "isoganai / isoganakereba narimasen / isoganakute mo ii desu", bengali: "তাড়াহুড়া করি না / করতেই হবে / না করলেও চলে" },
      { prompt: "食べます", answer: "食べない／食べなければなりません／食べなくてもいいです", romaji: "tabenai / tabenakereba narimasen / tabenakute mo ii desu", bengali: "খাই না / খেতেই হবে / না খেলেও চলে" },
      { prompt: "します／来ます", answer: "しない／来ない", romaji: "shinai / konai", bengali: "করি না / আসি না" },
    ] },
    { step: "03", title: "練習B · Vないでください", instruction: "Public sign বা health advice দেখে ‘করবেন না’ sentence বলুন।", questions: [
      { prompt: "ここ／自転車／置きます", answer: "ここに 自転車を 置かないでください。", romaji: "Koko ni jitensha o okanaide kudasai.", bengali: "এখানে bicycle রাখবেন না।" },
      { prompt: "禁煙／たばこ／吸います", answer: "禁煙ですから、たばこを 吸わないでください。", romaji: "Kin'en desu kara, tabako o suwanaide kudasai.", bengali: "ধূমপান নিষেধ, তাই cigarette খাবেন না।" },
      { prompt: "danger／enter", answer: "危ないですから、ここに 入らないでください。", romaji: "Abunai desu kara, koko ni hairanaide kudasai.", bengali: "বিপজ্জনক, তাই এখানে ঢুকবেন না।" },
      { prompt: "health／worry", answer: "大丈夫ですから、心配しないでください。", romaji: "Daijoubu desu kara, shinpai shinaide kudasai.", bengali: "সব ঠিক আছে, চিন্তা করবেন না।" },
    ] },
    { step: "04", title: "練習B · Obligation and deadline", instruction: "Duty cue-তে なければなりません এবং deadline-এ までに ব্যবহার করুন।", questions: [
      { prompt: "あした 病院／行きます", answer: "あした 病院へ 行かなければなりません。", romaji: "Ashita byouin e ikanakereba narimasen.", bengali: "কাল হাসপাতালে যেতেই হবে।" },
      { prompt: "passport／持って行きます", answer: "パスポートを 持って 行かなければなりません。", romaji: "Pasupooto o motte ikanakereba narimasen.", bengali: "Passport সঙ্গে নিতেই হবে।" },
      { prompt: "毎朝 5時／起きます", answer: "毎朝 5時に 起きなければなりません。", romaji: "Maiasa goji ni okinakereba narimasen.", bengali: "প্রতিদিন পাঁচটায় উঠতেই হয়।" },
      { prompt: "土曜日／book return", answer: "土曜日までに 本を 返さなければなりません。", romaji: "Doyoubi made ni hon o kaesanakereba narimasen.", bengali: "শনিবারের মধ্যে বই ফেরত দিতেই হবে।" },
    ] },
    { step: "05", title: "練習B · Vなくてもいいです", instruction: "যে কাজটি প্রয়োজন নেই সেটি ‘না করলেও চলে’ form-এ বলুন।", questions: [
      { prompt: "Sunday／early wake", answer: "日曜日は 早く 起きなくてもいいです。", romaji: "Nichiyoubi wa hayaku okinakute mo ii desu.", bengali: "রবিবার তাড়াতাড়ি না উঠলেও চলে।" },
      { prompt: "tomorrow／come", answer: "あしたは 来なくてもいいです。", romaji: "Ashita wa konakute mo ii desu.", bengali: "কাল না এলেও চলবে।" },
      { prompt: "report／today submit", answer: "レポートは きょう 出さなくてもいいです。", romaji: "Repooto wa kyou dasanakute mo ii desu.", bengali: "Report আজ জমা না দিলেও চলবে।" },
      { prompt: "medicine／no fever", answer: "熱が ありませんから、薬を 飲まなくてもいいです。", romaji: "Netsu ga arimasen kara, kusuri o nomanakute mo ii desu.", bengali: "জ্বর নেই, তাই ওষুধ না খেলেও চলে।" },
    ] },
    { step: "06", title: "会話 · どうしましたか", instruction: "Symptom, diagnosis, obligation ও doctor advice মিলিয়ে clinic role-play সম্পূর্ণ করুন।", questions: [
      { prompt: "Doctor asks the problem", answer: "どうしましたか。— きのうから のどが 痛くて、熱も 少し あります。", romaji: "Dou shimashita ka. — Kinou kara nodo ga itakute, netsu mo sukoshi arimasu.", bengali: "কী হয়েছে?—গতকাল থেকে গলা ব্যথা ও সামান্য জ্বর।" },
      { prompt: "2–3 days rest", answer: "2、3日 ゆっくり 休んでください。", romaji: "Ni-san nichi yukkuri yasunde kudasai.", bengali: "দুই-তিন দিন ভালোভাবে বিশ্রাম নিন।" },
      { prompt: "tomorrow Tokyo business trip／must", answer: "あしたから 東京へ 出張しなければなりません。", romaji: "Ashita kara Toukyou e shucchou shinakereba narimasen.", bengali: "কাল থেকে Tokyo-তে business trip-এ যেতেই হবে।" },
      { prompt: "tonight bath／do not", answer: "今晩は お風呂に 入らないでください。", romaji: "Konban wa ofuro ni hairanaide kudasai.", bengali: "আজ রাতে গোসল করবেন না।" },
    ] },
    { step: "07", title: "Health role-play · Symptoms and advice", instruction: "Patient-এর symptom শুনে natural Japanese advice দিন।", questions: [
      { prompt: "頭が痛い + fever", answer: "熱を 測って、薬を 飲んでください。今日は 無理をしないでください。", romaji: "Netsu o hakatte, kusuri o nonde kudasai. Kyou wa muri o shinaide kudasai.", bengali: "জ্বর মেপে ওষুধ খান। আজ জোর করবেন না।" },
      { prompt: "stomachache／hospital", answer: "おなかが 痛いですか。病院へ 行かなければなりません。", romaji: "Onaka ga itai desu ka. Byouin e ikanakereba narimasen.", bengali: "পেটব্যথা? হাসপাতালে যেতেই হবে।" },
      { prompt: "cough and runny nose", answer: "せきと 鼻水が 出ます。— かぜですね。ゆっくり 休んでください。", romaji: "Seki to hanamizu ga demasu. — Kaze desu ne. Yukkuri yasunde kudasai.", bengali: "কাশি ও নাক দিয়ে পানি পড়ে।—সর্দি হয়েছে, বিশ্রাম নিন।" },
      { prompt: "no appetite／take care", answer: "食欲が ありません。— 水を 飲んで、早く 寝てください。お大事に。", romaji: "Shokuyoku ga arimasen. — Mizu o nonde, hayaku nete kudasai. Odaiji ni.", bengali: "রুচি নেই।—পানি পান করে তাড়াতাড়ি ঘুমান। নিজের যত্ন নিন।" },
    ] },
    { step: "08", title: "問題 · Unit 17 self-test", instruction: "ない-form, deadline, health advice ও contextual choice একসঙ্গে প্রয়োগ করুন।", questions: [
      { prompt: "帰ります → ない-form", answer: "帰らない", romaji: "kaeranai", bengali: "ফিরি না" },
      { prompt: "忘れます → must not forget", answer: "忘れないでください。", romaji: "Wasurenaide kudasai.", bengali: "ভুলবেন না।" },
      { prompt: "9:00／class／enter by", answer: "9時までに 教室に 入らなければなりません。", romaji: "Kuji made ni kyoushitsu ni hairanakereba narimasen.", bengali: "নয়টার মধ্যে classroom-এ ঢুকতেই হবে।" },
      { prompt: "Pencil exam; pen not necessary", answer: "答えは 鉛筆で 書いてください。ボールペンは 使わなくてもいいです。", romaji: "Kotae wa enpitsu de kaite kudasai. Boorupen wa tsukawanakute mo ii desu.", bengali: "উত্তর pencil-এ লিখুন; ballpen ব্যবহার না করলেও চলে।" },
      { prompt: "Passport deadline Friday", answer: "金曜日までに パスポートを 持って来なければなりません。", romaji: "Kinyoubi made ni pasupooto o motte konakereba narimasen.", bengali: "শুক্রবারের মধ্যে passport আনতেই হবে।" },
    ] },
  ],
};

const unitEighteenPractice: UnitPracticeDetails = {
  heroImage: "/images/projects/n5-vocabulary/unit-18.webp",
  heroAlt: "সামর্থ্য, শখ, কাজের আগের প্রস্তুতি এবং ভ্রমণ নিয়ে Unit 18 practice illustration",
  dialogueImage: "/images/projects/n5-vocabulary/unit-18.webp",
  heroEyebrow: "UNIT 18 · DICTIONARY FORM · ABILITY · HOBBIES",
  heroTitle: "আপনি কী করতে পারেন, আর আপনার শখ কী?",
  heroDescription: "Verb-এর dictionary form তৈরি করে সামর্থ্য, শখ এবং কোনো কাজের আগের action প্রকাশ করুন; conversation ও picture drill দিয়ে patternগুলো active recall করুন।",
  dialogueTitle: "趣味は 何ですか · Talking about hobbies",
  dialogueAlt: "সান্তোস ও ইয়ামাদা প্রাণী ও ঘোড়ার ছবি তোলার শখ নিয়ে কথা বলছেন",
  dialogueCaption: [
    { name: "山田", text: "サントスさんの 趣味は 何ですか。" },
    { name: "サントス", text: "写真です。特に 馬が 好きです。" },
    { name: "山田", text: "北海道に 馬が たくさん いますよ。" },
  ],
  modelLabel: "文型モデル",
  modelTitle: "Vることができます · 趣味はVることです · Vるまえに",
  challengeTitle: "Ability and hobby mission",
  challengeDescription: "নিজের তিনটি সামর্থ্য, একটি শখ এবং প্রতিদিন কোনো কাজের আগে করা দুইটি প্রস্তুতি Japanese-এ বলুন।",
  usefulWords: [
    { japanese: "～ことが できます", romaji: "~ koto ga dekimasu", bengali: "～করতে পারি/করা সম্ভব" },
    { japanese: "趣味", romaji: "shumi", bengali: "শখ" },
    { japanese: "～まえに", romaji: "~ mae ni", bengali: "～এর আগে" },
    { japanese: "なかなか～ません", romaji: "nakanaka ~masen", bengali: "সহজে/প্রত্যাশামতো ～হয় না" },
    { japanese: "特に", romaji: "toku ni", bengali: "বিশেষ করে" },
    { japanese: "ぜひ", romaji: "zehi", bengali: "অবশ্যই/খুবই চাই" },
    { japanese: "予約します", romaji: "yoyaku shimasu", bengali: "reservation করি" },
    { japanese: "換えます", romaji: "kaemasu", bengali: "বদলাই/বিনিময় করি" },
  ],
  answerPatterns: [
    { japanese: "Nが できます。", romaji: "N ga dekimasu.", bengali: "N পারি।", positive: true },
    { japanese: "Vることが できます。", romaji: "V-ru koto ga dekimasu.", bengali: "কাজটি করতে পারি।", positive: true },
    { japanese: "趣味は Vることです。", romaji: "Shumi wa V-ru koto desu.", bengali: "শখ হলো কাজটি করা।", positive: true },
    { japanese: "Vる／Nの まえに、V。", romaji: "V-ru / N no mae ni, V.", bengali: "কাজ/N-এর আগে আরেকটি কাজ করি।", positive: true },
  ],
  memoryPoints: [
    { symbol: "Group I", meaning: "i-row → u-row: 書きます→書く" },
    { symbol: "Group II", meaning: "ます বাদ + る: 食べます→食べる" },
    { symbol: "Group III", meaning: "します→する; 来ます→来る" },
    { symbol: "こと", meaning: "verb action-কে noun phrase বানায়" },
    { symbol: "Nのまえに", meaning: "noun-এর পরে の প্রয়োজন" },
    { symbol: "Timeまえに", meaning: "সময়কাল হলে の লাগে না" },
  ],
  selfIntroduction: {
    japanese: "わたしは 日本語を 話すことが できます。趣味は 写真を 撮ることです。旅行する まえに、ホテルを 予約します。北海道へ ぜひ 行きたいです。",
    romaji: "Watashi wa Nihongo o hanasu koto ga dekimasu. Shumi wa shashin o toru koto desu. Ryokou suru mae ni, hoteru o yoyaku shimasu. Hokkaidou e zehi ikitai desu.",
    bengali: "আমি Japanese বলতে পারি। আমার শখ ছবি তোলা। ভ্রমণের আগে hotel reserve করি। Hokkaido-তে অবশ্যই যেতে চাই।",
  },
  grammarQuiz: [
    { question: "読みます-এর dictionary form কোনটি?", options: ["読む", "読みる", "読まない", "読んで"], correctAnswer: "読む", explanation: "Group I-তে み sound একই row-এর む-তে বদলায়।" },
    { question: "‘Kanji পড়তে পারি’—কোনটি ঠিক?", options: ["漢字を 読むことが できます。", "漢字を 読みますことが できます。", "漢字が 読むできます。", "漢字を 読んで できます。"], correctAnswer: "漢字を 読むことが できます。", explanation: "Ability-তে dictionary form + ことができます ব্যবহার হয়।" },
    { question: "‘আমার শখ গান শোনা’—কোনটি ঠিক?", options: ["趣味は 音楽を 聞くことです。", "趣味は 音楽を 聞きますことです。", "趣味が 音楽を 聞くです。", "趣味は 音楽を 聞いてです。"], correctAnswer: "趣味は 音楽を 聞くことです。", explanation: "Action-কে hobby হিসেবে বললে V-dictionary + ことです।" },
    { question: "‘ঘুমানোর আগে’ কোনটি?", options: ["寝るまえに", "寝ますまえに", "寝たまえに", "寝るのまえに"], correctAnswer: "寝るまえに", explanation: "Verb-এর পরে まえに বসলে verb dictionary form নেয় এবং の লাগে না।" },
    { question: "‘খাবারের আগে’ কোনটি?", options: ["食事の まえに", "食事を まえに", "食事が まえに", "食事するの まえに"], correctAnswer: "食事の まえに", explanation: "Noun-এর পরে の + まえに লাগে।" },
    { question: "なかなか-এর beginner pattern কোনটি?", options: ["なかなか 覚えられません。", "なかなか 覚えます。", "なかなか 覚えたいです。", "なかなか 覚えてください。"], correctAnswer: "なかなか 覚えられません。", explanation: "なかなか সাধারণত negative expression-এর সঙ্গে ‘সহজে নয়’ অর্থ দেয়।" },
  ],
  dialogue: [
    { speaker: "山田", japanese: "サントスさんの 趣味は 何ですか。", romaji: "Santosu-san no shumi wa nan desu ka.", bengali: "সান্তোস-সান, আপনার শখ কী?" },
    { speaker: "サントス", japanese: "写真です。", romaji: "Shashin desu.", bengali: "Photography।" },
    { speaker: "山田", japanese: "どんな 写真を 撮りますか。", romaji: "Donna shashin o torimasu ka.", bengali: "কেমন ছবি তোলেন?" },
    { speaker: "サントス", japanese: "動物の 写真です。特に 馬が 好きです。", romaji: "Doubutsu no shashin desu. Toku ni uma ga suki desu.", bengali: "প্রাণীর ছবি। বিশেষ করে ঘোড়া পছন্দ করি।" },
    { speaker: "山田", japanese: "へえ、それは おもしろいですね。日本へ 来てから、馬の 写真を 撮りましたか。", romaji: "Hee, sore wa omoshiroi desu ne. Nihon e kite kara, uma no shashin o torimashita ka.", bengali: "বাহ, মজার তো। Japan আসার পর ঘোড়ার ছবি তুলেছেন?" },
    { speaker: "サントス", japanese: "いいえ。日本では なかなか 馬を 見ることが できません。", romaji: "Iie. Nihon de wa nakanaka uma o miru koto ga dekimasen.", bengali: "না। Japan-এ সহজে ঘোড়া দেখা যায় না।" },
    { speaker: "山田", japanese: "北海道に 馬が たくさん いますよ。", romaji: "Hokkaidou ni uma ga takusan imasu yo.", bengali: "Hokkaido-তে অনেক ঘোড়া আছে।" },
    { speaker: "サントス", japanese: "本当ですか。じゃ、夏休みに ぜひ 行きたいです。", romaji: "Hontou desu ka. Ja, natsuyasumi ni zehi ikitai desu.", bengali: "সত্যি? তাহলে গ্রীষ্মের ছুটিতে অবশ্যই যেতে চাই।" },
  ],
  profiles: [],
  modules: [
    { step: "01", title: "文型・例文 · Ability, hobby and before", instruction: "বইয়ের model pattern দেখে prompt-কে সম্পূর্ণ Japanese sentence-এ বদলান।", questions: [
      { prompt: "ミラー／漢字／read／can", answer: "ミラーさんは 漢字を 読むことが できます。", romaji: "Miraa-san wa kanji o yomu koto ga dekimasu.", bengali: "মিলার kanji পড়তে পারেন।" },
      { prompt: "わたし／趣味／映画を見る", answer: "わたしの 趣味は 映画を 見ることです。", romaji: "Watashi no shumi wa eiga o miru koto desu.", bengali: "আমার শখ cinema দেখা।" },
      { prompt: "寝ます／before／日記を書きます", answer: "寝る まえに、日記を 書きます。", romaji: "Neru mae ni, nikki o kakimasu.", bengali: "ঘুমানোর আগে diary লিখি।" },
      { prompt: "3年前／結婚しました", answer: "3年まえに 結婚しました。", romaji: "Sannen mae ni kekkon shimashita.", bengali: "তিন বছর আগে বিয়ে করেছি।" },
    ] },
    { step: "02", title: "練習A · Dictionary-form builder", instruction: "ます-form দেখে Group চিনে dictionary form বলুন।", questions: [
      { prompt: "書きます／急ぎます／話します／待ちます", answer: "書く／急ぐ／話す／待つ", romaji: "kaku / isogu / hanasu / matsu", bengali: "লেখা / তাড়াহুড়া করা / কথা বলা / অপেক্ষা করা" },
      { prompt: "飲みます／遊びます／帰ります", answer: "飲む／遊ぶ／帰る", romaji: "nomu / asobu / kaeru", bengali: "পান করা / খেলা / ফেরা" },
      { prompt: "食べます／見ます", answer: "食べる／見る", romaji: "taberu / miru", bengali: "খাওয়া / দেখা" },
      { prompt: "運転します／来ます", answer: "運転する／来る", romaji: "unten suru / kuru", bengali: "গাড়ি চালানো / আসা" },
    ] },
    { step: "03", title: "練習B · ～ことができます", instruction: "ছবি বা cue দেখে কে কী করতে পারে/পারে না—question-answer তৈরি করুন।", questions: [
      { prompt: "ミラー／tennis", answer: "ミラーさんは テニスが できますか。— はい、できます。", romaji: "Miraa-san wa tenisu ga dekimasu ka. — Hai, dekimasu.", bengali: "মিলার tennis পারেন?—হ্যাঁ, পারেন।" },
      { prompt: "マリア／bicycle", answer: "マリアさんは 自転車に 乗ることが できますか。— いいえ、できません。", romaji: "Maria-san wa jitensha ni noru koto ga dekimasu ka. — Iie, dekimasen.", bengali: "মারিয়া bicycle চালাতে পারেন?—না, পারেন না।" },
      { prompt: "ここ／cash exchange", answer: "ここで 現金を 換えることが できます。", romaji: "Koko de genkin o kaeru koto ga dekimasu.", bengali: "এখানে নগদ টাকা বদলানো যায়।" },
      { prompt: "hotel／card payment／cannot", answer: "この ホテルでは カードで 払うことが できません。", romaji: "Kono hoteru de wa kaado de harau koto ga dekimasen.", bengali: "এই hotel-এ card দিয়ে পরিশোধ করা যায় না।" },
    ] },
    { step: "04", title: "練習B · どんな外国語が話せますか", instruction: "Ability interview করুন এবং quantity/skill cue দিয়ে answer দিন।", questions: [
      { prompt: "外国語／English", answer: "どんな 外国語を 話すことが できますか。— 英語を 話すことが できます。", romaji: "Donna gaikokugo o hanasu koto ga dekimasu ka. — Eigo o hanasu koto ga dekimasu.", bengali: "কোন বিদেশি ভাষা বলতে পারেন?—English বলতে পারি।" },
      { prompt: "swim／100 meters", answer: "どのくらい 泳ぐことが できますか。— 100メートルぐらい 泳ぐことが できます。", romaji: "Dono kurai oyogu koto ga dekimasu ka. — Hyaku meetoru gurai oyogu koto ga dekimasu.", bengali: "কত দূর সাঁতার কাটতে পারেন?—প্রায় ১০০ মিটার।" },
      { prompt: "Japanese food／tempura", answer: "どんな 日本料理を 作ることが できますか。— 天ぷらを 作ることが できます。", romaji: "Donna Nihon ryouri o tsukuru koto ga dekimasu ka. — Tenpura o tsukuru koto ga dekimasu.", bengali: "কোন Japanese খাবার রান্না করতে পারেন?—Tempura।" },
    ] },
    { step: "05", title: "練習B · 趣味は何ですか", instruction: "Noun বা dictionary-form + こと দিয়ে hobby interview সম্পূর্ণ করুন।", questions: [
      { prompt: "読む／古い時計を集める", answer: "趣味は 何ですか。— 古い 時計を 集めることです。", romaji: "Shumi wa nan desu ka. — Furui tokei o atsumeru koto desu.", bengali: "শখ কী?—পুরোনো ঘড়ি সংগ্রহ করা।" },
      { prompt: "スポーツ／見る", answer: "わたしの 趣味は スポーツを 見ることです。", romaji: "Watashi no shumi wa supootsu o miru koto desu.", bengali: "আমার শখ খেলাধুলা দেখা।" },
      { prompt: "動物／写真を撮る", answer: "趣味は 動物の 写真を 撮ることです。", romaji: "Shumi wa doubutsu no shashin o toru koto desu.", bengali: "শখ প্রাণীর ছবি তোলা।" },
      { prompt: "音楽／歌う", answer: "趣味は 歌を 歌うことです。", romaji: "Shumi wa uta o utau koto desu.", bengali: "শখ গান গাওয়া।" },
    ] },
    { step: "06", title: "練習B · ～まえに", instruction: "Verb, noun ও time-period cue আলাদা করে সঠিক まえに pattern বানান।", questions: [
      { prompt: "ごはんを食べます／hands wash", answer: "ごはんを 食べる まえに、手を 洗います。", romaji: "Gohan o taberu mae ni, te o araimasu.", bengali: "খাবারের আগে হাত ধুই।" },
      { prompt: "旅行／camera buy", answer: "旅行の まえに、カメラを 買いました。", romaji: "Ryokou no mae ni, kamera o kaimashita.", bengali: "ভ্রমণের আগে camera কিনেছিলাম।" },
      { prompt: "2 weeks ago／reservation", answer: "2週間まえに ホテルを 予約しました。", romaji: "Nishuukan mae ni hoteru o yoyaku shimashita.", bengali: "দুই সপ্তাহ আগে hotel reserve করেছি।" },
      { prompt: "9:00 meeting／資料 copy", answer: "9時の 会議の まえに、資料を コピーします。", romaji: "Kuji no kaigi no mae ni, shiryou o kopii shimasu.", bengali: "নয়টার meeting-এর আগে materials copy করি।" },
    ] },
    { step: "07", title: "練習C · 趣味は何ですか", instruction: "শখ, বিস্তারিত পছন্দ, Japan-এ সুযোগ এবং future wish নিয়ে পূর্ণ role-play করুন।", questions: [
      { prompt: "Ask Santos's hobby", answer: "サントスさんの 趣味は 何ですか。— 写真です。", romaji: "Santosu-san no shumi wa nan desu ka. — Shashin desu.", bengali: "সান্তোসের শখ কী?—Photography।" },
      { prompt: "What photos／animals, especially horses", answer: "どんな 写真を 撮りますか。— 動物の 写真です。特に 馬が 好きです。", romaji: "Donna shashin o torimasu ka. — Doubutsu no shashin desu. Toku ni uma ga suki desu.", bengali: "কী ধরনের ছবি?—প্রাণীর; বিশেষ করে ঘোড়া।" },
      { prompt: "Japan／horses／not easily see", answer: "日本では なかなか 馬を 見ることが できません。", romaji: "Nihon de wa nakanaka uma o miru koto ga dekimasen.", bengali: "Japan-এ সহজে ঘোড়া দেখা যায় না।" },
      { prompt: "Hokkaido／summer vacation／strong wish", answer: "夏休みに 北海道へ ぜひ 行きたいです。", romaji: "Natsuyasumi ni Hokkaidou e zehi ikitai desu.", bengali: "গ্রীষ্মের ছুটিতে Hokkaido-তে অবশ্যই যেতে চাই।" },
    ] },
    { step: "08", title: "問題 · Unit 18 self-test", instruction: "Dictionary form, ability, hobby, まえに এবং reading comprehension একসঙ্গে প্রয়োগ করুন।", questions: [
      { prompt: "買います／急ぎます／来ます → dictionary", answer: "買う／急ぐ／来る", romaji: "kau / isogu / kuru", bengali: "কেনা / তাড়াহুড়া করা / আসা" },
      { prompt: "カード／make; そのあと／book borrow", answer: "借りる まえに、カードを 作らなければなりません。", romaji: "Kariru mae ni, kaado o tsukuranakereba narimasen.", bengali: "ধার নেওয়ার আগে card বানাতে হবে।" },
      { prompt: "library／コピー／possible", answer: "図書館で コピーすることが できます。", romaji: "Toshokan de kopii suru koto ga dekimasu.", bengali: "Library-তে photocopy করা যায়।" },
      { prompt: "Reading／アレーシャの趣味", answer: "本を 読むことです。", romaji: "Hon o yomu koto desu.", bengali: "বই পড়া।" },
      { prompt: "Reading／本を借りる条件", answer: "借りる まえに、カードを 作らなければなりません。", romaji: "Kariru mae ni, kaado o tsukuranakereba narimasen.", bengali: "বই নেওয়ার আগে card বানাতে হবে।" },
      { prompt: "Reading／コピー代", answer: "1枚 10円です。", romaji: "Ichimai juu-en desu.", bengali: "প্রতি page ১০ yen।" },
    ] },
  ],
};

const unitNineteenPractice: UnitPracticeDetails = {
  heroImage: "/images/projects/n5-vocabulary/unit-19.webp",
  heroAlt: "অতীত অভিজ্ঞতা, ছুটির কাজ, শরীরের পরিবর্তন এবং diet নিয়ে Unit 19 practice illustration",
  dialogueImage: "/images/projects/n5-vocabulary/unit-19.webp",
  heroEyebrow: "UNIT 19 · た-FORM · EXPERIENCE · CHANGE",
  heroTitle: "কখনো করেছেন? ছুটিতে কী কী করেন?",
  heroDescription: "た-form দিয়ে অতীত অভিজ্ঞতা ও representative action বলুন এবং adjective বা noun-এর পরিবর্তিত অবস্থা なります দিয়ে প্রকাশ করুন।",
  dialogueTitle: "ダイエットは あしたから します · Diet starts tomorrow",
  dialogueAlt: "Restaurant-এ Maria ও Matsumoto diet এবং ice cream নিয়ে কথা বলছেন",
  dialogueCaption: [
    { name: "松本", text: "わたしも ダイエットを したことが あります。" },
    { name: "マリア", text: "どんな ダイエットですか。" },
    { name: "マリア", text: "ダイエットは また あしたから します。" },
  ],
  modelLabel: "文型モデル",
  modelTitle: "Vたことがあります · VたりVたりします · ～く／～になります",
  challengeTitle: "Experience and change mission",
  challengeDescription: "নিজের তিনটি অভিজ্ঞতা, ছুটির দিনের কয়েকটি কাজ এবং জীবনের দুইটি পরিবর্তন Japanese-এ প্রকাশ করুন।",
  usefulWords: [
    { japanese: "～たことが あります", romaji: "~ta koto ga arimasu", bengali: "～করার অভিজ্ঞতা আছে" },
    { japanese: "一度も ありません", romaji: "ichido mo arimasen", bengali: "একবারও নেই/করিনি" },
    { japanese: "～たり、～たりします", romaji: "~tari, ~tari shimasu", bengali: "～করি, ～করি ইত্যাদি" },
    { japanese: "～く なります", romaji: "~ku narimasu", bengali: "い-adjective অবস্থায় পরিণত হয়" },
    { japanese: "～に なります", romaji: "~ ni narimasu", bengali: "な-adjective/noun অবস্থায় পরিণত হয়" },
    { japanese: "だんだん", romaji: "dandan", bengali: "ধীরে ধীরে" },
    { japanese: "もうすぐ", romaji: "mou sugu", bengali: "শিগগিরই" },
    { japanese: "おかげさまで", romaji: "okagesama de", bengali: "আপনাদের দোয়ায়/সহায়তায়" },
  ],
  answerPatterns: [
    { japanese: "はい、Vたことが あります。", romaji: "Hai, V-ta koto ga arimasu.", bengali: "হ্যাঁ, কাজটি করার অভিজ্ঞতা আছে।", positive: true },
    { japanese: "いいえ、一度も ありません。", romaji: "Iie, ichido mo arimasen.", bengali: "না, একবারও নেই।", positive: false },
    { japanese: "Vたり、Vたりします。", romaji: "V-tari, V-tari shimasu.", bengali: "এই কাজ, ওই কাজ ইত্যাদি করি।", positive: true },
    { japanese: "Adjく／Adj・Nに なります。", romaji: "Adj-ku / Adj-N ni narimasu.", bengali: "নতুন অবস্থায় পরিণত হয়।", positive: true },
  ],
  memoryPoints: [
    { symbol: "て→た", meaning: "書いて→書いた; 食べて→食べた" },
    { symbol: "で→だ", meaning: "飲んで→飲んだ; 泳いで→泳いだ" },
    { symbol: "たり", meaning: "সব কাজ নয়—কয়েকটি representative example" },
    { symbol: "い→く", meaning: "寒い→寒くなります" },
    { symbol: "な・N→に", meaning: "元気→元気に; 医者→医者に" },
    { symbol: "一度も", meaning: "negative-এর সঙ্গে ‘একবারও নয়’" },
  ],
  selfIntroduction: {
    japanese: "わたしは 富士山に 登ったことが あります。休みの 日は 本を 読んだり、音楽を 聞いたりします。日本語が だんだん 上手に なりました。",
    romaji: "Watashi wa Fujisan ni nobotta koto ga arimasu. Yasumi no hi wa hon o yondari, ongaku o kiitari shimasu. Nihongo ga dandan jouzu ni narimashita.",
    bengali: "আমি Fuji পাহাড়ে উঠেছি। ছুটির দিনে বই পড়ি, music শুনি ইত্যাদি। আমার Japanese ধীরে ধীরে ভালো হয়েছে।",
  },
  grammarQuiz: [
    { question: "飲みます-এর た-form কোনটি?", options: ["飲んだ", "飲みた", "飲った", "飲んた"], correctAnswer: "飲んだ", explanation: "飲んで-এর で বদলে だ হয়: 飲んだ।" },
    { question: "‘কখনো ঘোড়ায় চড়েছি’—কোনটি ঠিক?", options: ["馬に 乗ったことが あります。", "馬に 乗ることが ありました。", "馬に 乗ってことが あります。", "馬に 乗りますことが あります。"], correctAnswer: "馬に 乗ったことが あります。", explanation: "অতীত অভিজ্ঞতায় Vた-form + ことがあります।" },
    { question: "‘একবারও করিনি’—সঠিক answer কোনটি?", options: ["一度も ありません。", "一度 あります。", "一度も あります。", "一度 ありませんでしたか。"], correctAnswer: "一度も ありません。", explanation: "一度も সবসময় negative predicate-এর সঙ্গে আসে।" },
    { question: "ছুটির দিনে কয়েকটি representative কাজ বলতে কোনটি?", options: ["本を 読んだり、音楽を 聞いたりします。", "本を 読んで、音楽を 聞きます。", "本を 読むたり、音楽を 聞くたりします。", "本を 読みたり、音楽を 聞きたりします。"], correctAnswer: "本を 読んだり、音楽を 聞いたりします。", explanation: "প্রতিটি verb-এর た-form + り ব্যবহার হয়।" },
    { question: "‘ঠান্ডা হয়ে যায়’—কোনটি ঠিক?", options: ["寒く なります。", "寒いに なります。", "寒くに なります。", "寒い なります。"], correctAnswer: "寒く なります。", explanation: "い-adjective-এর শেষ い বদলে く + なります।" },
    { question: "‘সুস্থ হয়ে গেছি’—কোনটি ঠিক?", options: ["元気に なりました。", "元気く なりました。", "元気な なりました。", "元気を なりました。"], correctAnswer: "元気に なりました。", explanation: "な-adjective-এর পরে に + なります বসে।" },
  ],
  dialogue: [
    { speaker: "松本", japanese: "マリアさん、あまり 食べませんね。", romaji: "Maria-san, amari tabemasen ne.", bengali: "মারিয়া-সান, আপনি খুব একটা খাচ্ছেন না।" },
    { speaker: "マリア", japanese: "ええ。きのうから ダイエットを しています。", romaji: "Ee. Kinou kara daietto o shite imasu.", bengali: "হ্যাঁ। গতকাল থেকে diet করছি।" },
    { speaker: "松本", japanese: "そうですか。わたしも ダイエットを したことが あります。", romaji: "Sou desu ka. Watashi mo daietto o shita koto ga arimasu.", bengali: "তাই নাকি। আমিও diet করেছি।" },
    { speaker: "マリア", japanese: "どんな ダイエットですか。", romaji: "Donna daietto desu ka.", bengali: "কেমন diet?" },
    { speaker: "松本", japanese: "毎日 りんごだけ 食べたり、水を たくさん 飲んだりしました。", romaji: "Mainichi ringo dake tabetari, mizu o takusan nondari shimashita.", bengali: "প্রতিদিন শুধু apple খেতাম, অনেক পানি পান করতাম ইত্যাদি।" },
    { speaker: "マリア", japanese: "そうですか。", romaji: "Sou desu ka.", bengali: "তাই নাকি।" },
    { speaker: "松本", japanese: "でも、無理な ダイエットは 体に よくないですね。", romaji: "Demo, muri na daietto wa karada ni yokunai desu ne.", bengali: "কিন্তু অতিরিক্ত diet স্বাস্থ্যের জন্য ভালো নয়।" },
    { speaker: "マリア", japanese: "そうですね。", romaji: "Sou desu ne.", bengali: "ঠিক বলেছেন।" },
    { speaker: "松本", japanese: "マリアさん、この アイスクリーム、おいしいですよ。", romaji: "Maria-san, kono aisukuriimu, oishii desu yo.", bengali: "মারিয়া-সান, এই ice cream সুস্বাদু।" },
    { speaker: "マリア", japanese: "そうですか。……ダイエットは また あしたから します。", romaji: "Sou desu ka. ... Daietto wa mata ashita kara shimasu.", bengali: "তাই নাকি! Diet আবার কাল থেকে করব।" },
  ],
  profiles: [],
  modules: [
    { step: "01", title: "文型・例文 · Experience and activities", instruction: "Model cue থেকে た-form, experience এবং representative-action sentence বানান।", questions: [
      { prompt: "相撲／see／experience", answer: "相撲を 見たことが あります。", romaji: "Sumou o mita koto ga arimasu.", bengali: "Sumo দেখার অভিজ্ঞতা আছে।" },
      { prompt: "休みの日／tennis + jogging", answer: "休みの 日は テニスを したり、ジョギングを したりします。", romaji: "Yasumi no hi wa tenisu o shitari, jogingu o shitari shimasu.", bengali: "ছুটির দিনে tennis খেলি, jogging করি ইত্যাদি।" },
      { prompt: "これから／cold", answer: "これから だんだん 寒く なります。", romaji: "Kore kara dandan samuku narimasu.", bengali: "এখন থেকে ধীরে ধীরে ঠান্ডা হবে।" },
      { prompt: "調子／how／good now", answer: "体の 調子は どうですか。— おかげさまで よく なりました。", romaji: "Karada no choushi wa dou desu ka. — Okagesama de yoku narimashita.", bengali: "শরীর কেমন?—আপনাদের দোয়ায় ভালো হয়েছে।" },
    ] },
    { step: "02", title: "練習A · た-form builder", instruction: "ます-form থেকে て-form মনে করে た-form তৈরি করুন।", questions: [
      { prompt: "書きます／行きます／急ぎます／飲みます", answer: "書いた／行った／急いだ／飲んだ", romaji: "kaita / itta / isoida / nonda", bengali: "লিখেছিল / গিয়েছিল / তাড়াহুড়া করেছিল / পান করেছিল" },
      { prompt: "遊びます／待ちます／話します", answer: "遊んだ／待った／話した", romaji: "asonda / matta / hanashita", bengali: "খেলেছিল / অপেক্ষা করেছিল / কথা বলেছিল" },
      { prompt: "食べます／見ます", answer: "食べた／見た", romaji: "tabeta / mita", bengali: "খেয়েছিল / দেখেছিল" },
      { prompt: "します／来ます", answer: "した／来た", romaji: "shita / kita", bengali: "করেছিল / এসেছিল" },
    ] },
    { step: "03", title: "練習B · Vたことがあります", instruction: "ছবি বা cue দেখে অভিজ্ঞতা আছে কি না question-answer করুন।", questions: [
      { prompt: "広島／go", answer: "広島へ 行ったことが ありますか。— はい、あります。", romaji: "Hiroshima e itta koto ga arimasu ka. — Hai, arimasu.", bengali: "Hiroshima গেছেন?—হ্যাঁ।" },
      { prompt: "Fuji／climb／never", answer: "富士山に 登ったことが ありますか。— いいえ、一度も ありません。", romaji: "Fujisan ni nobotta koto ga arimasu ka. — Iie, ichido mo arimasen.", bengali: "Fuji উঠেছেন?—না, একবারও নয়।" },
      { prompt: "Japanese tea ceremony／experience", answer: "茶道を したことが あります。", romaji: "Sadou o shita koto ga arimasu.", bengali: "Tea ceremony করার অভিজ্ঞতা আছে।" },
      { prompt: "Japanese food／eat", answer: "日本料理を 食べたことが ありますか。", romaji: "Nihon ryouri o tabeta koto ga arimasu ka.", bengali: "Japanese খাবার কখনো খেয়েছেন?" },
    ] },
    { step: "04", title: "練習B · Vたり、Vたりします", instruction: "দিন বা পরিস্থিতির cue দেখে কয়েকটি representative action বলুন।", questions: [
      { prompt: "日曜日／掃除 + 洗濯", answer: "日曜日は 掃除したり、洗濯したりします。", romaji: "Nichiyoubi wa souji shitari, sentaku shitari shimasu.", bengali: "রবিবার পরিষ্কার করি, কাপড় ধুই ইত্যাদি।" },
      { prompt: "休みの日／shopping + movie", answer: "休みの 日は 買い物に 行ったり、映画を 見たりします。", romaji: "Yasumi no hi wa kaimono ni ittari, eiga o mitari shimasu.", bengali: "ছুটিতে shopping-এ যাই, cinema দেখি ইত্যাদি।" },
      { prompt: "昨夜／music + book", answer: "きのうの 夜は 音楽を 聞いたり、本を 読んだりしました。", romaji: "Kinou no yoru wa ongaku o kiitari, hon o yondari shimashita.", bengali: "গত রাতে music শুনেছি, বই পড়েছি ইত্যাদি।" },
      { prompt: "夏休み／swim + mountain", answer: "夏休みは 泳いだり、山に 登ったりしたいです。", romaji: "Natsuyasumi wa oyoidari, yama ni nobottari shitai desu.", bengali: "গ্রীষ্মের ছুটিতে সাঁতার কাটতে ও পাহাড়ে উঠতে চাই ইত্যাদি।" },
    ] },
    { step: "05", title: "練習B · ～く／～に なります", instruction: "পুরোনো অবস্থা থেকে নতুন অবস্থায় change sentence তৈরি করুন।", questions: [
      { prompt: "寒い／winter", answer: "冬に なると、寒く なります。", romaji: "Fuyu ni naru to, samuku narimasu.", bengali: "শীত এলে ঠান্ডা হয়ে যায়।" },
      { prompt: "元気／medicine", answer: "薬を 飲んで、元気に なりました。", romaji: "Kusuri o nonde, genki ni narimashita.", bengali: "ওষুধ খেয়ে সুস্থ হয়েছি।" },
      { prompt: "日本語／上手／practice", answer: "毎日 練習して、日本語が 上手に なりました。", romaji: "Mainichi renshuu shite, Nihongo ga jouzu ni narimashita.", bengali: "প্রতিদিন অনুশীলন করে Japanese ভালো হয়েছে।" },
      { prompt: "next month／25 years old", answer: "来月 25歳に なります。", romaji: "Raigetsu nijuugosai ni narimasu.", bengali: "আগামী মাসে ২৫ বছর বয়স হবে।" },
    ] },
    { step: "06", title: "会話 · ダイエットはあしたから", instruction: "Diet experience, representative actions এবং humorous ending দিয়ে dialogue সম্পূর্ণ করুন।", questions: [
      { prompt: "Maria／not eating much／since yesterday", answer: "きのうから ダイエットを しています。", romaji: "Kinou kara daietto o shite imasu.", bengali: "গতকাল থেকে diet করছি।" },
      { prompt: "Matsumoto／diet experience", answer: "わたしも ダイエットを したことが あります。", romaji: "Watashi mo daietto o shita koto ga arimasu.", bengali: "আমিও diet করেছি।" },
      { prompt: "apple + water／past examples", answer: "りんごだけ 食べたり、水を たくさん 飲んだりしました。", romaji: "Ringo dake tabetari, mizu o takusan nondari shimashita.", bengali: "শুধু apple খেতাম, অনেক পানি পান করতাম ইত্যাদি।" },
      { prompt: "ice cream temptation／diet tomorrow", answer: "ダイエットは また あしたから します。", romaji: "Daietto wa mata ashita kara shimasu.", bengali: "Diet আবার কাল থেকে করব।" },
    ] },
    { step: "07", title: "Culture role-play · 日本で何をしましたか", instruction: "Traditional culture vocabulary ব্যবহার করে experience ও activity interview করুন।", questions: [
      { prompt: "Kabuki／see／ever", answer: "歌舞伎を 見たことが ありますか。— はい、一度 あります。", romaji: "Kabuki o mita koto ga arimasu ka. — Hai, ichido arimasu.", bengali: "Kabuki দেখেছেন?—হ্যাঁ, একবার।" },
      { prompt: "Kyoto／tea ceremony + flower arranging", answer: "京都で 茶道を したり、生け花を 習ったりしました。", romaji: "Kyouto de sadou o shitari, ikebana o narattari shimashita.", bengali: "Kyoto-তে tea ceremony করেছি, ikebana শিখেছি ইত্যাদি।" },
      { prompt: "kendo／never", answer: "剣道を したことが ありますか。— いいえ、一度も ありません。", romaji: "Kendou o shita koto ga arimasu ka. — Iie, ichido mo arimasen.", bengali: "Kendo করেছেন?—না, একবারও নয়।" },
      { prompt: "calligraphy／gradually better", answer: "毎週 練習して、書道が だんだん 上手に なりました。", romaji: "Maishuu renshuu shite, shodou ga dandan jouzu ni narimashita.", bengali: "প্রতি সপ্তাহে অনুশীলন করে calligraphy ধীরে ধীরে ভালো হয়েছে।" },
    ] },
    { step: "08", title: "問題 · Unit 19 self-test", instruction: "た-form, experience, representative action, change ও Mt. Fuji reading মিলিয়ে উত্তর দিন।", questions: [
      { prompt: "行きます／飲みます／します → た-form", answer: "行った／飲んだ／した", romaji: "itta / nonda / shita", bengali: "গিয়েছিল / পান করেছিল / করেছিল" },
      { prompt: "沖縄／experience／once", answer: "沖縄へ 行ったことが あります。", romaji: "Okinawa e itta koto ga arimasu.", bengali: "Okinawa যাওয়ার অভিজ্ঞতা আছে।" },
      { prompt: "Saturday／cleaning + shopping", answer: "土曜日は 掃除したり、買い物に 行ったりします。", romaji: "Doyoubi wa souji shitari, kaimono ni ittari shimasu.", bengali: "শনিবার পরিষ্কার করি, shopping-এ যাই ইত্যাদি।" },
      { prompt: "Mt. Fuji height", answer: "富士山は 3,776メートルです。", romaji: "Fujisan wa sanzen nanahyaku nanajuuroku meetoru desu.", bengali: "Fuji পাহাড় ৩,৭৭৬ মিটার উঁচু।" },
      { prompt: "Best climbing season", answer: "夏は 7月1日から 8月31日まで 登ることが できます。", romaji: "Natsu wa shichigatsu tsuitachi kara hachigatsu sanjuuichinichi made noboru koto ga dekimasu.", bengali: "গ্রীষ্মে ১ জুলাই থেকে ৩১ আগস্ট পর্যন্ত ওঠা যায়।" },
      { prompt: "Winter Fuji／color change", answer: "冬の 富士山は 雪で 白く なります。", romaji: "Fuyu no Fujisan wa yuki de shiroku narimasu.", bengali: "শীতে Fuji তুষারে সাদা হয়ে যায়।" },
    ] },
  ],
};
...
export function getMinnaN5PracticeDetails(unitNumber: number) {
  ...
  if (unitNumber === 15) return unitFifteenPractice;
  if (unitNumber === 16) return unitSixteenPractice;
  if (unitNumber === 17) return unitSeventeenPractice;
  if (unitNumber === 18) return unitEighteenPractice;
  if (unitNumber === 19) return unitNineteenPractice;
  return undefined;
}
