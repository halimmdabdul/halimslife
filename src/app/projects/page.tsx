...
type IconName =
  "arrow" | "book" | "code" | "cycle" | "idea" | "process" | "star" | "target";
  ...
  const paths: Record<IconName, React.ReactNode> = {
    ...
    idea: (
      <>
        ...
        <path d="M8.5 15.5a6 6 0 1 1 7 0c-.8.6-1.2 1.3-1.3 2.5h-4.4c-.1-1.2-.5-1.9-1.3-2.5Z" />
      </>
    ),
    process: (
      <>
        ...
        <path d="M7 12h5m2-1 3-4m-3 6 3 4" />
      </>
    ),
    star: (
      <path d="m12 3 2.5 5.4 5.8.7-4.3 4 1.2 5.9-5.2-3-5.2 3 1.2-5.9-4.3-4 5.8-.7L12 3Z" />
    ),
    target: (
      <>
      ...
      <main className={styles.page}>
        <section className={styles.hero}>
          <div className={styles.heroCopy}>
            <span className={styles.kicker}>আমার Projects</span>
            <h1>
              যে <em>tools</em> ও resources
              <br />
              মানুষকে এক ধাপ এগিয়ে নেয়।
            </h1>
            <p>
            ...
            <div className={styles.heroActions}>
              <a href="#featured">Featured project দেখুন ↓</a>
              <a
        ...
        <section id="featured" className={styles.section}>
          <NumberTitle number="01">Featured Project</NumberTitle>
          <article className={styles.featured}>
            ...
            <div className={styles.featuredCopy}>
              <span>Japanese learning · Interactive</span>
              <h2>KanaStory</h2>
              <p>
                Story এবং interactive practice-এর মাধ্যমে hiragana ও katakana
                শেখার একটি beginner-friendly experience।
              </p>
              <dl>
                <div>
                  <dt>Problem</dt>
                  <dd>
                    Kana শেখার শুরু beginner-এর জন্য repetitive এবং difficult
                    মনে হয়।
                  </dd>
                </div>
                <div>
                  <dt>Solution</dt>
                  <dd>
                    Story, visual memory এবং interactive practice একসঙ্গে।
                  </dd>
                </div>
                <div>
                  <dt>Audience</dt>
                  <dd>Japanese language beginners</dd>
                </div>
              </dl>
              <h3>Key Features</h3>
              ...
              <Link className={styles.greenLink} href="/learn-kana">
                Project দেখুন →
              </Link>
            </div>
            <aside className={styles.designed}>
              ...
              <Image
                src={journeyArt}
                alt="Japanese pagoda watercolor"
                fill
                sizes="22vw"
              />
            </aside>
        ...
        <section id="learning" className={styles.section}>
          <NumberTitle number="02">JLPT বাংলা Learning Ecosystem</NumberTitle>
          <h2 className={styles.sectionHeading}>
            N5 থেকে structured Japanese learning path।
          </h2>
          <div className={styles.learningGrid}>
            ...
            <article>
              ...
              <small>Japanese learning · Practice tests</small>
              <h3>Honman Test</h3>
              <p>
                চারটি আলাদা practice set থেকে test বেছে নিয়ে Japanese learning
                progress যাচাই করার সহজ project।
              </p>
              <div className={styles.chips}>
                <span>Test 1</span>
                <span>Test 2</span>
              ...
              <Link className={styles.greenLink} href="/projects/honman-test">
                Test বেছে নিন →
              </Link>
            </article>
            <article>
              ...
              <small>Kanji · Flashcards</small>
              <h3>N5 Kanji 100</h3>
              <p>
                JLPT N5-এর ১০০টি basic kanji flip-card আকারে অনুশীলন—meaning,
                reading, example ও নিজের মনে-থাকা progress track করুন।
              </p>
              <div className={styles.chips}>
                <span>100 Kanji</span>
              ...
              <Link className={styles.greenLink} href="/projects/n5-kanji">
                Kanji অনুশীলন করুন →
              </Link>
            </article>
            <article>
              ...
              <small>Kanji · বাংলা Shape Story</small>
              <h3>N4 Kanji 104</h3>
              <p>
                Exact reference order-এ ১০৪টি N4 Kanji—front reading, বাংলা
                meaning, “কেন এমন?” story এবং active recall সহ।
              </p>
              <div className={styles.chips}>
                <span>104 Kanji</span>
                <span>26 Stages</span>
              ...
              <Link className={styles.greenLink} href="/projects/n4-kanji">
                N4 Kanji শিখুন →
              </Link>
            </article>
            <article>
          ...
          <div className={styles.learningPath}>
            ...
            <span>🟩 JLPT N5</span>
            <i>→</i>
            <span>✅ Honman Test</span>
          </div>
        </section>
        <section id="open-source" className={styles.section}>
          <NumberTitle number="03">Open-source experiments</NumberTitle>
          <article className={styles.openSource}>
            <div>
              ...
              <p>
                Programming, education এবং ছোট practical tools নিয়ে আমার public
                code ও experiments।
              </p>
              <div className={styles.chips}>
              ...
              <a
                ...
                rel="noreferrer"
              >
                GitHub profile দেখুন ↗
              </a>
            </div>
            <div className={styles.codeImage}>
              <Image
                src={codeArt}
                alt="Programming and code illustration"
                fill
                sizes="38vw"
              />
            </div>
            <div className={styles.experimentList}>
              <p>
                ...
                <span>
                  <b>Web experiments</b>
                  <small>Small web apps and interactive demos.</small>
                </span>
              </p>
              <p>
                <Icon name="book" />
                <span>
                  <b>Learning tools</b>
                  <small>Tools that make learning more effective.</small>
                </span>
              </p>
              <p>
                <Icon name="code" />
                <span>
                  ...
                  <small>Notes and practical references.</small>
                </span>
              </p>
            </div>
          </article>
        ...
        <section className={styles.section}>
          <NumberTitle number="04">আমার project philosophy</NumberTitle>
          <div className={styles.philosophy}>
            <article>
              <Icon name="target" />
              <div>
                <h3>Useful first</h3>
                <p>প্রতিটি project একটি real learning problem solve করে।</p>
              </div>
            </article>
            <article>
              <Icon name="idea" />
              <div>
                ...
                <p>Complex information সহজ ও navigable করা।</p>
              </div>
            </article>
            <article>
              <Icon name="cycle" />
              <div>
                ...
                <p>Feedback দিয়ে নিয়মিত iteration।</p>
              </div>
            </article>
          </div>
        </section>
        <section id="process" className={styles.section}>
          <NumberTitle number="05">Project process</NumberTitle>
          <div className={styles.process}>
            {[
              ["Understand", "learner/user problem পরিষ্কার করি"],
              ["Structure", "content এবং information architecture তৈরি করি"],
              ["Build", "responsive interactive experience তৈরি করি"],
              ["Improve", "feedback নিয়ে iteration করি"],
          ...
          <p className={styles.processNote}>
            Idea থেকে মানুষের কাজে লাগে এমন resource—ধাপে ধাপে সেই পথ।
          </p>
        </section>
        <section className={styles.next}>
          <div>
            <NumberTitle number="06">What&apos;s next</NumberTitle>
            <h2>
              আরও Bengali-friendly
              <br />
              learning tools তৈরি হচ্ছে।
            </h2>
            <p>
              Japanese language, programming এবং Japan career-এর জন্য practical
              resources তৈরি করতে চাই।
            </p>
            <div>
              <Link href="/academy">আমার সাথে শিখুন</Link>
              <Link href="/contact">যোগাযোগ করুন</Link>
            </div>
          </div>
          <Image
            src={journeyArt}
            alt="Mount Fuji and Japan watercolor landscape"
            fill
            sizes="55vw"
          />
        </section>
