...
export default function AboutPage(){return <div className={styles.page}><SiteHeader/><main>
  ...
  <section id="story" className={styles.story}><SectionTitle number="01">আমার গল্প</SectionTitle><div className={styles.storyGrid}><div><h3>Curiosity থেকে Japan-এর engineering career।</h3><p>বাংলাদেশে বড় হওয়ার সময় থেকেই প্রশ্ন করতাম—“কেন” আর “কীভাবে”। জানার এই আগ্রহই আমাকে প্রযুক্তির দিকে টেনে আনে।</p><p><Link href="/scholarships">Scholarship</Link> নিয়ে পড়াশোনার সময় থেকে Japan-এ engineering career গড়ার প্রতিটি ধাপ আমাকে বাস্তব সমস্যার সমাধানে প্রযুক্তি কাজে লাগাতে শিখিয়েছে। See my <Link href="/journey">Bangladesh-to-Japan journey</Link> and <Link href="/scholarships">scholarship guides</Link>.</p><div className={styles.tags}><span>Bangladesh → Japan</span><span>Scholarship recipient</span><span>Lifelong learner</span></div></div><div className={styles.map}><Image src={aboutMap} alt="Watercolor map showing Bangladesh to Japan" fill sizes="50vw"/></div></div></section>
