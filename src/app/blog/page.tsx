...
export default async function BlogPage({searchParams}:{searchParams:Promise<{q?:string}>}){
  ...
  return <InnerPageShell><main className={styles.page}>
    ...
    <section className={styles.topics}>
      <h2>যেসব বিষয় নিয়ে লিখি</h2>
      <div>
        <article><Image src={careerArt} alt="Japan career watercolor" fill sizes="25vw"/><div><h3>Japan Career</h3><p>জাপানের কর্মসংস্কৃতি, communication ও career গড়ার বাস্তব অভিজ্ঞতা।</p></div></article>
        <article><Image src={manufacturingArt} alt="Engineering watercolor" fill sizes="25vw"/><div><h3>Engineering</h3><p>Systems, research ও বাস্তব সমস্যা সমাধানের engineering insights।</p></div></article>
        <article><Image src={codeArt} alt="Programming watercolor" fill sizes="25vw"/><div><h3>Programming</h3><p>Code, tools ও useful project তৈরির practical notes ও শেখা।</p></div></article>
        <article><Image src={japaneseArt} alt="Japanese learning watercolor" fill sizes="25vw"/><div><h3>Japanese Learning</h3><p>বাংলাভাষীদের জন্য সহজ Japanese guide, practice ও resources।</p></div></article>
      </div>
    </section>
