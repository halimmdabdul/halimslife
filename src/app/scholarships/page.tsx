...
export const metadata: Metadata = { title:"International Graduate Scholarship Guides | Halim", description:"Practical graduate funding and scholarship guides for the USA, Canada, South Korea, Switzerland, Italy and Japan.", alternates:{canonical:"/scholarships"} };
