...
export default async function ScholarshipsPage({searchParams}:{searchParams:Promise<{country?:string;q?:string;filter?:string}>}){
  ...
  const countryOptions=[
    {value:"usa",flag:"🇺🇸",label:"USA",count:usaGuides.length},
    {value:"canada",flag:"🇨🇦",label:"Canada",count:canadaGuides.length},
    {value:"korea",flag:"🇰🇷",label:"South Korea",count:koreaGuides.length},
    {value:"switzerland",flag:"🇨🇭",label:"Switzerland",count:swissGuides.length},
    {value:"italy",flag:"🇮🇹",label:"Italy",count:italyGuides.length},
    {value:"japan",flag:"🇯🇵",label:"Japan",count:japanGuides.length},
  ];
