...
import navigatorHero from "@/assets/scholarships/navigator-world-map-hero.png";
import { SiteFooter } from "@/components/site-footer";
import { SiteHeader } from "@/components/site-header";
import { ScholarshipProfileModal } from "@/components/scholarship-profile-modal";
import { UniversityPhoto } from "@/components/university-photo";
import { PopularScholarships } from "@/components/popular-scholarships";
...
export const metadata: Metadata = { title:"Japan & Global Scholarship Guides for Bangladeshis", description:"Scholarship and admission guides for Bangladeshi students, led by 13+ Japan university programs, plus the USA, Canada, South Korea, Switzerland and Italy.", alternates:{canonical:"/scholarships"} };
...
const italyGuides=scholarshipGuides
  .filter(g=>g.country==="italy")
  .sort((a,b)=>(a.italyPriority??Number.MAX_SAFE_INTEGER)-(b.italyPriority??Number.MAX_SAFE_INTEGER));
...
function CountryFlag({country}:{country:string}){
  ...
  if(country==="canada")return <svg viewBox="0 0 36 24" aria-hidden="true"><rect width="36" height="24" fill="#fff"/><path fill="#d80621" d="M0 0h8v24H0zm28 0h8v24h-8zM18 3l1.8 4 3.2-1.2-1.4 3 3 1.3-3.7 3 .9 3.2-3-1.2.2 5h-2l.2-5-3 1.2.9-3.2-3.7-3 3-1.3-1.4-3L16.2 7z"/></svg>;
  if(country==="korea")return <svg viewBox="0 0 36 24" aria-hidden="true"><rect width="36" height="24" fill="#fff"/><path fill="#cd2e3a" d="M18 6a6 6 0 0 1 0 12 3 3 0 0 0 0-6 3 3 0 0 1 0-6z"/><path fill="#0047a0" d="M18 18a6 6 0 0 1 0-12 3 3 0 0 0 0 6 3 3 0 0 1 0 6z"/><g stroke="#111" strokeWidth="1.2"><path d="M5 5l5 3m-4-5 5 3m14 12 5 3m-4-5 5 3M6 19l5-3m-6 5 5-3m16-12 5-3m-6 5 5-3"/></g></svg>;
  if(country==="switzerland")return <svg viewBox="0 0 36 24" aria-hidden="true"><rect width="36" height="24" fill="#d52b1e"/><path fill="#fff" d="M15 4h6v5h5v6h-5v5h-6v-5h-5V9h5z"/></svg>;
  if(country==="italy")return <svg viewBox="0 0 36 24" aria-hidden="true"><path fill="#009246" d="M0 0h12v24H0z"/><path fill="#fff" d="M12 0h12v24H12z"/><path fill="#ce2b37" d="M24 0h12v24H24z"/></svg>;
